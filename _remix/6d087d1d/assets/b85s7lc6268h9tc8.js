import{y as e,O as L,X as S,r as p,a6 as Y,ag as Z,ck as Q,da as k,eA as d,C as ee,av as E,a1 as r,bq as te,ap as O}from"./qt4wss72u2iiwb12.js";import{o as ae,q as se,fc as re,h as oe,a1 as J,J as w,U as ie,fd as b}from"./essdexqvqu02rgqn.js";import{Y as B}from"./mzkxlhrlmxhntkvn.js";import{A as ne}from"./bk2m2r3cpjr4pkx7.js";import{F as le,O as ce,aZ as de,p as ue}from"./mj1bo2bvsdcuqwn0.js";import{F as me,a as U,b as N}from"./nd32l9o6zacvhdxe.js";import{a as pe,b as he}from"./e35ravnv1um3e6pq.js";import"./il13svm8z46vwj7c.js";import"./nyafg151eqhmq9mq.js";import"./epo75wihakppz7a8.js";import"./eixpuwitl9sszofn.js";import"./nldl9h83w2w2p8e7.js";import"./inwaqyhkeiulw8e8.js";import"./g53wp1fz9j23sg74.js";import"./e07xeu5zi6rth7jm.js";import"./bpykej1504xqtnru.js";import"./fsddy3bxlesj6ecw.js";import"./ehyjmqre1iuv5xnh.js";import"./cwqpfqiyqgvzfexw.js";import"./cki7q0rothorf8gt.js";import"./g2z2evai3603aozf.js";import"./dk42zn752mgi7t43.js";import"./hm2o7iguqbjp347m.js";import"./jgo01kpq4t1kgbqt.js";import"./lyvan9oso5scelhw.js";import"./cwyi921uz3ijtelp.js";import"./junr6rvvs2nkjh8o.js";import"./6bb90yacv3xqgsg1.js";import"./iorvpedrfxnoycni.js";import"./lzkd8nhhz0rpbybt.js";import"./oz2p326ip1qkp1yw.js";import"./cqjhevi2hictlclg.js";import"./lpv78gcbu761i6tm.js";import"./frazneop97dpz2zw.js";import"./pcggbxr6hulrl2lb.js";import"./d0mshaqotoswy47e.js";import"./oyixhgf2ek57szce.js";import"./hudcs4pqc4nukiau.js";import"./jrgi17awm0lxf0zo.js";import"./c2isyhxzg9dfq3cz.js";import"./ouy0e10bjw097ebb.js";import"./kqdn195asmrrxa5y.js";function xe({className:a,children:n,...o}){return e.jsx(ae,{className:a,...o,children:n})}const fe=({value:a,className:n,label:o,...l})=>e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx(se,{id:a,value:a,className:L("h-4 w-4 flex-shrink-0 gap-2 rounded-full border border-token-text-tertiary bg-transparent shadow-sm outline-none hover:bg-token-main-surface-tertiary",n),...l}),e.jsx("label",{htmlFor:a,className:"w-full cursor-pointer",children:o})]}),ge=({className:a,...n})=>e.jsx(re,{className:L("relative flex h-full w-full items-center justify-center after:block after:h-2 after:w-2 after:rounded-[50%] after:bg-token-text-primary after:content-['']",a),...n}),R={Root:xe,Item:fe,Indicator:ge};function ye({onSelectExample:a}){const n=S(),o=p.useRef(null);return e.jsxs("select",{onChange:l=>{if(l.target.value==="label")return;const t=parseInt(l.target.value);a(H[t].spec),o.current.value="label"},className:"h-8 rounded-lg border border-token-border-medium bg-transparent px-2 py-0 text-sm",ref:o,children:[e.jsx("option",{value:"label",children:n.formatMessage(I.examples)}),H.map((l,t)=>e.jsx("option",{value:t,children:n.formatMessage(l.displayName)},t))]})}const je={openapi:"3.1.0",info:{title:"Get weather data",description:"Retrieves current weather data for a location.",version:"v1.0.0"},servers:[{url:"https://weather.example.com"}],paths:{"/location":{get:{description:"Get temperature for a specific location",operationId:"GetCurrentWeather",parameters:[{name:"location",in:"query",description:"The city and state to retrieve the weather for",required:!0,schema:{type:"string"}}],deprecated:!1}}},components:{schemas:{}}},ve=`# Taken from https://github.com/OAI/OpenAPI-Specification/blob/main/examples/v3.0/petstore.yaml
...
//# sourceMappingURL=b85s7lc6268h9tc8.js.map
