import{l as e,m as U,X as S,r as p,a0 as Y,aN as Z,cp as Q,dc as k,ez as d,ad as ee,bg as E,$ as r,Y as te,aZ as R}from"./isi6i55eeemdaxmu.js";import{n as ae,o as se,f0 as re,e as oe,ag as J,$ as w,I as ne,f1 as b}from"./g344clpmm9csab6e.js";import{Y as B}from"./mzkxlhrlmxhntkvn.js";import{A as ie}from"./c22s2l3g9xlhfu68.js";import{G as le,R as ce,aZ as de,p as ue}from"./lzv3m24lczy39xt0.js";import{F as me,a as L,b as N}from"./li23hgshvaazrqed.js";import{a as pe,b as he}from"./nnk23yq585nr5uyx.js";import"./r2u8flwozaontxkq.js";import"./egewzi8a5y7qju58.js";import"./degf32ael4dvv0yi.js";import"./mvhwdrwl9svu63x5.js";import"./megy9kkk9hn5qfg6.js";import"./fx7mucxyea7fii3k.js";import"./mmok6cc45zl1vh57.js";import"./fsddy3bxlesj6ecw.js";import"./l04gzu1n7hg31jxj.js";import"./ib0ms42s8384cd3v.js";import"./ohpoyszch3mlqwsm.js";import"./loixfmr6ytf0pfrm.js";import"./d74pqb25x2nbe4b7.js";import"./jtrkdsj2hd1164z4.js";import"./czq4y95706tw281o.js";import"./buoh6uwgso1uhk9b.js";import"./gbddh2xz504ppd4e.js";import"./mrm5pxqw6vj7wrlo.js";import"./ih0flb1f55glrdm0.js";import"./g2onwas6lnzml0up.js";import"./h9ualmnhqdfirnsv.js";import"./nowwicm4997e8k9h.js";import"./e1xxkngo1ewql2ra.js";import"./ocw6b0d0fdszq9kd.js";import"./eftlnpn8u5t3089f.js";import"./lprujriozzruq7gg.js";import"./avr0ug3rb4vl6ah2.js";import"./pddn3ipakn4prkls.js";function xe({className:a,children:i,...o}){return e.jsx(ae,{className:a,...o,children:i})}const fe=({value:a,className:i,label:o,...l})=>e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx(se,{id:a,value:a,className:U("h-4 w-4 flex-shrink-0 gap-2 rounded-full border border-token-text-tertiary bg-transparent shadow-sm outline-none hover:bg-token-main-surface-tertiary",i),...l}),e.jsx("label",{htmlFor:a,className:"w-full cursor-pointer",children:o})]}),ge=({className:a,...i})=>e.jsx(re,{className:U("relative flex h-full w-full items-center justify-center after:block after:h-2 after:w-2 after:rounded-[50%] after:bg-token-text-primary after:content-['']",a),...i}),O={Root:xe,Item:fe,Indicator:ge};function ye({onSelectExample:a}){const i=S(),o=p.useRef(null);return e.jsxs("select",{onChange:l=>{if(l.target.value==="label")return;const t=parseInt(l.target.value);a(H[t].spec),o.current.value="label"},className:"h-8 rounded-lg border border-token-border-medium bg-transparent px-2 py-0 text-sm",ref:o,children:[e.jsx("option",{value:"label",children:i.formatMessage(I.examples)}),H.map((l,t)=>e.jsx("option",{value:t,children:i.formatMessage(l.displayName)},t))]})}const je={openapi:"3.1.0",info:{title:"Get weather data",description:"Retrieves current weather data for a location.",version:"v1.0.0"},servers:[{url:"https://weather.example.com"}],paths:{"/location":{get:{description:"Get temperature for a specific location",operationId:"GetCurrentWeather",parameters:[{name:"location",in:"query",description:"The city and state to retrieve the weather for",required:!0,schema:{type:"string"}}],deprecated:!1}}},components:{schemas:{}}},ve=`# Taken from https://github.com/OAI/OpenAPI-Specification/blob/main/examples/v3.0/petstore.yaml
...
//# sourceMappingURL=i0m2vb0baxlj291a.js.map
