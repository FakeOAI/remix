import{w as I,I as u,D as j,r as s,bd as S,e8 as A,C as E,a2 as W,j as e,G as a,c as y,ba as N,H as M}from"./nz057gr5epx40qb6.js";import{aL as F}from"./f6nleccxr4ywnup7.js";import{T as B}from"./njy57tbztf4mi4mi.js";import{a2 as L,t as O}from"./dqhf08ckfv2lp5xs.js";const H={flags:{failwhaleBypassEnabled:!1,sharingEnabled:!1}},R=I()((i,n)=>({...H,updateFlagValue:(l,h)=>{const c=n().flags;i({flags:{...c,[l]:h}})}}));function _(){const i=j(),n=R(o=>o.flags.failwhaleBypassEnabled),[l,h]=s.useState(!1),[c,b]=s.useState(!1),d=F(),m=s.useRef(w[Math.floor(Math.random()*w.length)]),[r,T]=s.useState(!1),[C,g]=s.useState(!1),[p,k]=s.useState(!1),f=S();s.useEffect(()=>{document.title="ChatGPT",b(!0)},[]),s.useEffect(()=>{d(()=>{h(!0)},1e3)},[d]);const x=s.useCallback(o=>{o.preventDefault();const P=o.target,G=A(P.email.value);g(!0),E.getLoginLink(G).catch(v=>{W.forError(v)}).finally(()=>{g(!1),T(!0)})},[]);return c?e.jsx(q,{children:e.jsxs("div",{className:"relative flex h-full w-full overflow-hidden",children:[e.jsxs(z,{children:[e.jsx("div",{className:"text-3xl font-semibold",children:e.jsx(a,{...t.title})}),e.jsx("a",{href:"https://share.hsforms.com/13gyIEVN5SrScw-iVvCgIew4sk30",target:"_blank",rel:"noreferrer",className:"underline",children:e.jsx(a,{...t.getNotified})}),e.jsx("div",{className:"flex",children:e.jsx("div",{className:"font-bold",children:m.current.prompt})}),e.jsx("div",{className:"max-w-lg pb-8",children:e.jsx(B,{value:m.current.completion,typing:l,speed:150,chunk:!0})})]}),n&&e.jsx(J,{$show:p,children:e.jsxs("div",{className:"relative m-6 flex w-full flex-col justify-center gap-4 text-gray-800 lg:max-w-sm lg:rounded-lg lg:border lg:p-6",children:[f&&e.jsx("h3",{children:e.jsx(a,{...t.chatGPTPlus})}),!f&&e.jsxs("button",{className:"text-center text-xl font-semibold lg:text-left",onClick:()=>k(o=>!o),children:[e.jsx(a,{...t.chatGPTPlus}),e.jsx(L,{className:y("icon-lg absolute right-0 top-0",!p&&"rotate-180")})]}),e.jsxs("div",{className:"m-auto flex w-full max-w-md flex-col gap-4 rounded-md border p-6 lg:border-0 lg:p-0",children:[!r&&e.jsx("p",{children:e.jsx(a,{...t.addEmail})}),r&&e.jsx("p",{children:e.jsx(a,{...t.allSet,values:{chatGPTPlus:e.jsx("a",{className:"underline",href:"https://openai.com/blog/chatgpt-plus/",children:"ChatGPT Plus"})}})}),e.jsxs("form",{onSubmit:x,children:[e.jsx("label",{htmlFor:"email",className:"hidden text-sm font-semibold text-gray-700",children:e.jsx(a,{...t.searchCandidates})}),e.jsxs("div",{className:"mt-1 flex rounded-md shadow-sm",children:[e.jsx("div",{className:"relative flex flex-grow items-stretch focus-within:z-10",children:e.jsx("input",{type:"email",name:"email",id:"email",className:y("form-input block w-full rounded-none rounded-l-md border-gray-300 focus:border-green-500 focus:ring-green-500 sm:text-sm",{"opacity-50":r}),required:!0,disabled:r,placeholder:i.formatMessage(t.emailPlaceholder)})}),e.jsx(N,{as:"button",color:"primary",className:"rounded-none rounded-r-md",type:"submit",disabled:r,loading:C,children:e.jsx("span",{className:"flex flex-row items-center space-x-1.5",children:r?e.jsxs(e.Fragment,{children:[e.jsx(O,{className:"icon-sm"}),e.jsx(a,{...t.sent})]}):e.jsx(a,{...t.sendLink})})})]})]}),e.jsx("p",{className:"text-sm",children:e.jsx(a,{...t.notSubscriber,values:{chatGPTPlus:e.jsx("a",{className:"underline",href:"https://openai.com/blog/chatgpt-plus/",children:"ChatGPT Plus"}),waitlist:o=>e.jsx("a",{href:"https://share.hsforms.com/1_-FpF2GTRJORIb83N3aK7Q4sk30",target:"_blank",rel:"noreferrer",className:"underline",children:o})}})})]})]})})]})}):null}const q=u.div`w-full h-full overflow-auto`,z=u.div`flex w-full max-w-lg mx-auto shrink-0 flex-col gap-6 overflow-auto px-6 pt-20 lg:w-3/5 lg:px-14 lg:pt-32 lg:max-w-none`,J=u.div`absolute bottom-0 w-full lg:w-auto lg:relative flex flex-grow items-center justify-center bg-white rounded-t-xl lg:rounded-none transition-transform
${({$show:i})=>!i&&"translate-y-[calc(100%-71px)] lg:translate-y-0"}`,t=M({title:{id:"CapacityGate.title",defaultMessage:"ChatGPT is at capacity right now"},getNotified:{id:"CapacityGate.getNotified",defaultMessage:"Get notified when we're back"},chatGPTPlus:{id:"CapacityGate.chatGPTPlus",defaultMessage:"ChatGPT Plus subscriber login"},allSet:{id:"CapacityGate.allSet",defaultMessage:"You're all set! If you're a {chatGPTPlus} subscriber, check your email for a login link."},addEmail:{id:"CapacityGate.addEmail",defaultMessage:"Add your email for a personalized login link"},searchCandidates:{id:"CapacityGate.searchCandidates",defaultMessage:"Search candidates"},emailPlaceholder:{id:"CapacityGate.emailPlaceholder",defaultMessage:"Email"},sendLink:{id:"CapacityGate.sendLink",defaultMessage:"Send link"},sent:{id:"CapacityGate.sent",defaultMessage:"Sent!"},notSubscriber:{id:"CapacityGate.notSubscriber",defaultMessage:"Not a {chatGPTPlus} subscriber yet? Join the <waitlist>waitlist</waitlist>."},waitlist:{id:"CapacityGate.waitlist",defaultMessage:"waitlist"}}),w=[{prompt:"Write a poem about the status of ChatGPT.",completion:`ChatGPT, oh ChatGPT
With AI so smart
...
3. ChatGPT can predict the future with 100% accuracy.`}];export{_ as C};
//# sourceMappingURL=jpfqjeyxdherk6xq.js.map
