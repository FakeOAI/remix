import{l as e,m as U,X as S,r as p,a0 as Y,aN as Z,cs as Q,df as k,eH as d,aj as ee,bg as E,$ as r,Y as te,aZ as O}from"./i02hakaw1yz2cb0w.js";import{n as ae,o as se,fe as re,e as oe,ag as J,$ as w,I as ne,ff as b}from"./ckygyr7dh5h6j13j.js";import{Y as H}from"./mzkxlhrlmxhntkvn.js";import{A as ie}from"./nryvegok6enbzgpn.js";import{H as le,T as ce,b2 as de,q as ue}from"./oolxnb4itrwnjqyf.js";import{F as me,a as L,b as N}from"./ew7ir3izl8xriyif.js";import{a as pe,b as he}from"./e6lel3g1dvrc3o39.js";import"./mv65vi40bwx8cy8n.js";import"./fy32gsgjnvmziir1.js";import"./j1601v2ihcbk1gfj.js";import"./j8pudfjo9hou5kw0.js";import"./bbilryt45cr5lkmt.js";import"./cpdqbxpekjursyhj.js";import"./fsddy3bxlesj6ecw.js";import"./hv7xf55q4xjiqsmg.js";import"./ona8lu2s6ochcv49.js";import"./b265g6ovy2qnenwi.js";import"./b7ag3k9iwm4mxpe7.js";import"./kbm7816v821c2spk.js";import"./oap30ledw1k6is17.js";import"./fo1cpvmyviez6pdv.js";import"./lh3mwfkwfhlv441f.js";import"./d5wegs5kxh8gy0hw.js";import"./i3dpv1f5ihn6o9pd.js";import"./jppq1up0yxybe7ed.js";import"./lznvc95l0hqf1fjq.js";import"./jy41gzsrlgtybzvn.js";import"./cw5lmig55hzmscts.js";import"./olnc3xl0j433b5ye.js";import"./ggngldwzadhac7xs.js";import"./i13uw1x5yijtp8f3.js";import"./nq860i125dfat6cp.js";import"./mvklc9o1473kp30d.js";import"./ivu7qbqshu9eraoy.js";import"./ka7sgnkfyonnm8ae.js";import"./ik0ionco6fs5t3nh.js";import"./j454liecuca977s7.js";import"./59fvijvcndvpx4su.js";function xe({className:a,children:i,...o}){return e.jsx(ae,{className:a,...o,children:i})}const fe=({value:a,className:i,label:o,...l})=>e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx(se,{id:a,value:a,className:U("h-4 w-4 flex-shrink-0 gap-2 rounded-full border border-token-text-tertiary bg-transparent shadow-sm outline-none hover:bg-token-main-surface-tertiary",i),...l}),e.jsx("label",{htmlFor:a,className:"w-full cursor-pointer",children:o})]}),ge=({className:a,...i})=>e.jsx(re,{className:U("relative flex h-full w-full items-center justify-center after:block after:h-2 after:w-2 after:rounded-[50%] after:bg-token-text-primary after:content-['']",a),...i}),R={Root:xe,Item:fe,Indicator:ge};function ye({onSelectExample:a}){const i=S(),o=p.useRef(null);return e.jsxs("select",{onChange:l=>{if(l.target.value==="label")return;const t=parseInt(l.target.value);a(B[t].spec),o.current.value="label"},className:"h-8 rounded-lg border border-token-border-medium bg-transparent px-2 py-0 text-sm",ref:o,children:[e.jsx("option",{value:"label",children:i.formatMessage(I.examples)}),B.map((l,t)=>e.jsx("option",{value:t,children:i.formatMessage(l.displayName)},t))]})}const je={openapi:"3.1.0",info:{title:"Get weather data",description:"Retrieves current weather data for a location.",version:"v1.0.0"},servers:[{url:"https://weather.example.com"}],paths:{"/location":{get:{description:"Get temperature for a specific location",operationId:"GetCurrentWeather",parameters:[{name:"location",in:"query",description:"The city and state to retrieve the weather for",required:!0,schema:{type:"string"}}],deprecated:!1}}},components:{schemas:{}}},ve=`# Taken from https://github.com/OAI/OpenAPI-Specification/blob/main/examples/v3.0/petstore.yaml
