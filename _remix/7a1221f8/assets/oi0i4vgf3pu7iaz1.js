import{l as e,m as U,V as S,r as p,a0 as Z,aN as Y,cs as Q,di as k,eG as d,ad as ee,be as E,Z as r,W as te,aZ as O}from"./pcg3wlqr9bj2vzgy.js";import{n as ae,o as se,ey as re,e as oe,ak as J,a5 as w,I as ie,ez as b}from"./h7654sawxikjkbks.js";import{Y as B}from"./mzkxlhrlmxhntkvn.js";import{A as ne}from"./cnuiz2xaitej322p.js";import{F as le,N as ce,aO as de,p as ue}from"./k3fj5qj7u1fb9jyd.js";import{F as me,a as L,b as N}from"./ow06q5j00z058ihq.js";import{a as pe,b as he}from"./4l36j9xd7ozkzi32.js";import"./fbj9i5osn7vd3ih5.js";import"./ix33iw8s97ved9s3.js";import"./d2lzesv7rn8u885d.js";import"./b5rukyt8lhk8a351.js";import"./ecl20unthbwwwfpd.js";import"./mp1soi9fngfd7n73.js";import"./cs9e4llgct35qss8.js";import"./fsddy3bxlesj6ecw.js";import"./i0dysmux6tle3g30.js";import"./hb8zz2sbyflgolag.js";import"./mk3biuocp806u2e1.js";import"./gm0evid4hgboh6pt.js";import"./q18mh3dj4y08h96f.js";import"./mar9ffl588mlroo6.js";import"./fd39oe0nkstpeo0t.js";import"./mtkzl5gkpho5w3mt.js";import"./gtbisz3czekoi6yp.js";import"./e1mwofhtljkdko3z.js";import"./57q8bc3bkmv9t8rt.js";import"./hktv5emxiyhcho4g.js";import"./jefi4vift47w9qn4.js";import"./lv8ww1pdv2ccielp.js";import"./opggz8bbemcbnfvv.js";import"./t7k2r6sxziidenzw.js";import"./gzs5jejtfho2l9sw.js";import"./hz6gf5icktxx5brt.js";import"./cdngc2ll4nomg6mq.js";import"./dfd7m9griy0mx0id.js";import"./kf8dqnsasf5eou41.js";import"./orxntzzz9oy4e698.js";import"./g7hpizxrzjd7s6vn.js";import"./h3tmu67wj7qg9qmj.js";import"./fzt1ty43j56jizfq.js";import"./lj8adjhcky9dh1ay.js";function xe({className:a,children:n,...o}){return e.jsx(ae,{className:a,...o,children:n})}const fe=({value:a,className:n,label:o,...l})=>e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx(se,{id:a,value:a,className:U("h-4 w-4 flex-shrink-0 gap-2 rounded-full border border-token-text-tertiary bg-transparent shadow-sm outline-none hover:bg-token-main-surface-tertiary",n),...l}),e.jsx("label",{htmlFor:a,className:"w-full cursor-pointer",children:o})]}),ge=({className:a,...n})=>e.jsx(re,{className:U("relative flex h-full w-full items-center justify-center after:block after:h-2 after:w-2 after:rounded-[50%] after:bg-token-text-primary after:content-['']",a),...n}),R={Root:xe,Item:fe,Indicator:ge};function ye({onSelectExample:a}){const n=S(),o=p.useRef(null);return e.jsxs("select",{onChange:l=>{if(l.target.value==="label")return;const t=parseInt(l.target.value);a(H[t].spec),o.current.value="label"},className:"h-8 rounded-lg border border-token-border-medium bg-transparent px-2 py-0 text-sm",ref:o,children:[e.jsx("option",{value:"label",children:n.formatMessage(I.examples)}),H.map((l,t)=>e.jsx("option",{value:t,children:n.formatMessage(l.displayName)},t))]})}const je={openapi:"3.1.0",info:{title:"Get weather data",description:"Retrieves current weather data for a location.",version:"v1.0.0"},servers:[{url:"https://weather.example.com"}],paths:{"/location":{get:{description:"Get temperature for a specific location",operationId:"GetCurrentWeather",parameters:[{name:"location",in:"query",description:"The city and state to retrieve the weather for",required:!0,schema:{type:"string"}}],deprecated:!1}}},components:{schemas:{}}},ve=`# Taken from https://github.com/OAI/OpenAPI-Specification/blob/main/examples/v3.0/petstore.yaml
...
//# sourceMappingURL=oi0i4vgf3pu7iaz1.js.map
