import{r as s,cD as jn,eT as W,G as qn,cT as Wn,hC as Hn,hD as Gn,eM as Xn,hs as $n,g as Kn,dQ as H,m as d,aD as Dn,bn as Tn,L as Rn,aU as F,ag as fn,dd as Yn,d3 as Zn,D as Jn,a_ as mn,c7 as Qn}from"./ejnnsd2ul10wwon8.js";import{am as ne,f as ee}from"./iq818lbd3vi25zxi.js";import{u as te}from"./hoa50yshgnfy7z32.js";import{k8 as kn,k9 as oe,n as ae,ka as se,je as ie,cz as re,kb as G,kc as le,bT as vn,bU as B,cp as ce,bn as ue,aF as de,d3 as gn,d2 as pn,kd as fe}from"./71wmxosf3hlynfn3.js";import{X as me,k as ve,l as ge,a as pe}from"./g5l9lzquxe1dsy3t.js";import{m as be}from"./bhodeadh6qtod2rx.js";const he=2,xe=({viewport:t,canvasSize:n,shouldMeasurePerf:e,source:i})=>{const o=s.useRef({}),a=s.useCallback(r=>{const f=r.getExtension("WEBGL_debug_renderer_info");f&&(o.current.vendor=r.getParameter(f.UNMASKED_VENDOR_WEBGL),o.current.renderer=r.getParameter(f.UNMASKED_RENDERER_WEBGL))},[]);return s.useEffect(()=>{const r={vendor:o.current.vendor??"(unavailable)",renderer:o.current.renderer??"(unavailable)",width:t[0],height:t[1],canvasWidth:n[0],canvasHeight:n[1],dpr:window.devicePixelRatio,source:i};!jn(r,o)&&e&&(o.current=r,kn(he).then(g=>{W.bloop.performance({...r,fps:g})}))},[n,e,t,i]),a},Se=.25,ye=3,bn=28,U=55,O=200,hn=1.1,Ae=({viewport:t,initialScale:n,shouldCalibrate:e})=>{const[i,o]=s.useState(n),a=s.useRef(void 0),r=s.useRef(void 0),f=s.useRef(void 0),g=s.useRef("down"),p=s.useCallback(()=>{const c=g.current==="up"?ye:Se;kn(c).then(u=>{if(u<bn){g.current="down";const m=Math.max(u,1),l=Math.sqrt(m/bn);o(h=>h*l),r.current=window.setTimeout(p,O)}else if(f.current){const m=u>=U,l=u>=f.current*hn;if(m||l)g.current="up",o(h=>h*hn),r.current=window.setTimeout(p,O);else if(u<U){g.current="down";const h=Math.sqrt(u/U);o(b=>b*h)}}f.current=u})},[]);return s.useEffect(()=>{const[c,u]=t,[m,l]=a.current??[];return e&&(m!==c||l!==u)&&(a.current=t,clearTimeout(r.current),o(n),r.current=window.setTimeout(p,O)),()=>{clearTimeout(r.current)}},[e,p,n,t]),i},Ce=60,P=Math.floor(1e3/Ce),we=(t,n)=>{const[e,i]=s.useState(t===n?performance.now():0),o=s.useRef(n);s.useEffect(()=>{o.current!==n&&t===n&&i(performance.now()),o.current=n},[n,t]);const a=s.useCallback(()=>{i(0)},[]);return[t===n?1:0,e,a]},De=([t,n,e],i=500)=>{const[o,a]=s.useState(t),r=s.useRef(t),f=s.useRef(void 0),g=s.useCallback((p,c,u)=>{const m=l=>{const h=Math.min((l-p)/i,1),b=c+h*(u-c);a(b),h<1&&(f.current=requestAnimationFrame(m))};f.current=requestAnimationFrame(m)},[i]);return s.useEffect(()=>{if(r.current!==t){r.current=t,f.current&&cancelAnimationFrame(f.current);const p=o,c=t;g(performance.now(),p,c)}},[g,o,t]),[o,n/1e3,e]};var Te=qn,Re=Wn;function ke(t){return Re(t)&&Te(t)}var Fe=ke,Me=Hn,_e=Xn,ze=$n,Ee=Gn,Pe=Fe,Ne=Math.max;function Le(t){if(!(t&&t.length))return[];var n=0;return t=Me(t,function(e){if(Pe(e))return n=Ne(e.length,n),!0}),Ee(n,function(e){return _e(t,ze(e))})}var Ie=Le,Be=oe,Ue=Ie,Oe=Be(Ue),Ve=Oe;const V=Kn(Ve),X=240,Fn=2048,Mn=new Array(X).fill(0),je=t=>{const n=me(t,{bands:X,updateInterval:P,loPass:0,hiPass:400,analyserOptions:{fftSize:Fn}});return n.length===0?Mn:n},$=t=>{const{magnitudes:n,binCount:e,gainMultiplier:i}=t;if(n.length===0)return new Array(e).fill(0);const o=Math.ceil(n.length/e),a=[];for(let r=0;r<n.length;r+=o){const f=Math.min(r+o,n.length),g=n.slice(r,f).sort((m,l)=>m-l),p=Math.floor(g.length/2);let c;g.length%2===0?c=(g[p-1]+g[p])/2:c=g[p],c=Math.abs(c),c*=i;const u=c/(c+1);a.push(u)}return a},_n=(t,n)=>{const e=n.sampleRate,i=t.length,o=n.bandCount,a=n.binCount,r=n.gainMultipliers;if(r.length!==o)throw new Error("gainMultipliers must have length equal to bandCount");const f=i*2,g=e/f,p=t.map((h,b)=>b*g),c=20,u=e/2,m=new Array(o+1).fill(0).map((h,b)=>c*Math.pow(u/c,b/o)),l=new Array(o).fill(null).map(()=>[]);for(let h=0;h<p.length;h+=1)for(let b=0;b<o;b+=1)if(p[h]>=m[b]&&p[h]<m[b+1]){l[b].push(t[h]);break}for(let h=0;h<o;h+=1){const b=l[h],v=r[h];l[h]=$({magnitudes:b,binCount:a,gainMultiplier:v})}return l},xn=60,zn=48e3,qe=1,We=2,He=40,Ge=2;function Sn({time:t,timeConstant:n}){return 1-Math.exp(-t/n)}function yn(t,n){const e=n[1]-n[0];return n[0]+t*e}const j=t=>{if(!Array.isArray(t)||t.length!==2||typeof t[0]!="number"||typeof t[1]!="number")throw new Error("zip failed - received a value that is not a [number, number] tuple")},Xe=t=>{const{prevAudioData:n,prevCumulativeAudioData:e,deltaTimeS:i,audioDataRaw:o}=t,a=o.map(m=>m*i*xn*qe),r=Sn({time:i,timeConstant:We}),f=V(n,a).map(m=>(j(m),yn(r,m))),g=o.map(m=>m*i*xn*He),p=V(e,g).map(m=>(j(m),m[0]+m[1])),c=Sn({time:i,timeConstant:Ge}),u=V(e,p).map(m=>(j(m),yn(c,m)));return{audioData:f,cumulativeAudioData:u}},zt=(t,n)=>{const e=je(t),i=_n(e,{sampleRate:zn,binCount:n.bins,bandCount:n.bands,gainMultipliers:n.gainMultipliers}),o=$({magnitudes:e,binCount:1,gainMultiplier:1});return{bandMagnitudes:i,cumulativeMagnitude:o}},$e="webp",Ke=512,Ye=512,Ze="srgb",Je=3,Qe="uchar",nt=72,et=!1,tt=8,ot=!1,at=!1,st="https://cdn.oaistatic.com/assets/noise-watercolor-m3j88gni.webp",it={format:$e,width:Ke,height:Ye,space:Ze,channels:Je,depth:Qe,density:nt,isProgressive:et,paletteBitDepth:tt,hasProfile:ot,hasAlpha:at,src:st};let K;const E=new window.Image;E.crossOrigin="anonymous";E.src=it.src;E.onload=()=>{K=E};function rt(t){const n=s.useRef(t);n.current=t;const[e,i]=s.useState(null),o=s.useCallback(a=>{i(a)},[]);return H(()=>{const a=new ResizeObserver(r=>{for(const f of r)n.current(f)});return e&&a.observe(e),()=>{a.disconnect()}},[e]),o}const R=ve.createChild("GLCanvas");function lt({className:t,vert:n,frag:e,Behaviors:i,onViewportUpdate:o,onRenderComplete:a,onGlAvailable:r,onCanvasSizeUpdate:f,scale:g}){const p=s.useRef(null),c=s.useRef(null),[u,m]=s.useState(null),[l,h]=s.useState(),b=s.useRef(ae(x=>{const{width:S,height:C}=x.contentRect,y=Math.floor(Math.min(S??0,C??0));m(y),o?.({width:y,height:y})},100)),v=rt(b.current);if(H(()=>{const x=p.current,{width:S,height:C}=x??{};if(x&&u!=null&&S&&C){const y=x.getContext("webgl2",{premultipliedAlpha:!0});y?h(y):R.error("webgl2 context not supported")}},[u]),H(()=>{if(!l)return;const x=l.createProgram(),S=l.createShader(l.VERTEX_SHADER),C=l.createShader(l.FRAGMENT_SHADER);if(!x){R.debug("failed to create program");return}if(!S||!C){R.debug("failed to create shaders",S,C);return}let y="";if(l.shaderSource(S,n),l.compileShader(S),y+=`vertShader:
...
${y}`;c.current=x,R.debug("program created"),r?.(l,x);const T=l.fenceSync(l.SYNC_GPU_COMMANDS_COMPLETE,0);return T&&(l.waitSync(T,0,l.TIMEOUT_IGNORED),a?.()),()=>{R.debug("cleaning up"),c.current=null,l.detachShader(x,S),l.detachShader(x,C),l.deleteShader(S),l.deleteShader(C),l.deleteProgram(x)}},[l,e,n]),u!=null&&l&&p.current){const x=p.current,S=u*window.devicePixelRatio*(g??1);x.width=S,x.height=S,l.viewport(0,0,S,S),f?.({width:S,height:S})}const w=c.current;return d.jsxs("div",{className:t,ref:v,children:[d.jsx("canvas",{ref:p,style:{width:u??void 0,height:u??void 0}},u),l&&w&&i&&d.jsx(i,{ctx:l,program:w})]})}function An({GLUniformsSetter:t,textureImage:n,textureName:e,variablesRef:i,className:o,vert:a,frag:r,onViewportUpdate:f,onRenderComplete:g,onGlAvailable:p,onCanvasSizeUpdate:c,scale:u}){const m=s.useRef(void 0),l=s.useCallback(async(v,w)=>{if(m.current=new t(v,w),n&&e){const x=v.createTexture();v.bindTexture(v.TEXTURE_2D,x),v.texParameteri(v.TEXTURE_2D,v.TEXTURE_WRAP_S,v.CLAMP_TO_EDGE),v.texParameteri(v.TEXTURE_2D,v.TEXTURE_WRAP_T,v.CLAMP_TO_EDGE),v.texParameteri(v.TEXTURE_2D,v.TEXTURE_MIN_FILTER,v.LINEAR),v.texParameteri(v.TEXTURE_2D,v.TEXTURE_MAG_FILTER,v.LINEAR),v.texImage2D(v.TEXTURE_2D,0,v.RGBA,v.RGBA,v.UNSIGNED_BYTE,n);const S=v.getUniformLocation(w,e);v.activeTexture(v.TEXTURE0),v.bindTexture(v.TEXTURE_2D,x),v.uniform1i(S,0)}p?.(v,w)},[t,n,e,p]),h=s.useRef(void 0),b=s.useCallback(()=>{m.current&&i.current&&m.current.setVariablesAndRender(i.current),h.current=requestAnimationFrame(b)},[i]);return s.useEffect(()=>(b(),()=>{h.current&&cancelAnimationFrame(h.current)}),[b]),d.jsx(lt,{className:o,vert:a,frag:r,onViewportUpdate:f,onRenderComplete:g,onGlAvailable:l,onCanvasSizeUpdate:c,scale:u,Behaviors:()=>null})}var ct=`#version 300 es
...
void main() {
  ...
  fragColor = vec4(sdf.color.rgb * alpha, alpha);
}`;class Z{#o;#i;#n;#a=[];#s={};#e;#t;static#r="BlorbUniformsObject";constructor(n,e){this.#n=n;const i=n.getUniformBlockIndex(e,Z.#r),o=n.getActiveUniformBlockParameter(e,i,n.UNIFORM_BLOCK_DATA_SIZE);this.#e=n.createBuffer(),n.bindBuffer(n.UNIFORM_BUFFER,this.#e),n.bufferData(n.UNIFORM_BUFFER,o,n.DYNAMIC_DRAW);const a=0;n.bindBufferBase(n.UNIFORM_BUFFER,a,this.#e),n.uniformBlockBinding(e,i,a);const r=n.getActiveUniformBlockParameter(e,i,n.UNIFORM_BLOCK_ACTIVE_UNIFORM_INDICES);this.#a=[],this.#s={};for(let f=0;f<r.length;f++){const g=r[f],p=n.getActiveUniform(e,g);if(!p)throw new Error("No uniformInfo for index "+g);let c=p.name;c=c.replace(/\[0\]$/,"");const u=n.getActiveUniforms(e,[g],n.UNIFORM_OFFSET)[0];this.#a.push(c),this.#s[c]=u}this.#t=new ArrayBuffer(o),this.#o=new Float32Array(this.#t),this.#i=new Int32Array(this.#t)}setVariablesAndRender(n){for(const e of this.#a){const[,i]=e.split("."),a=this.#s[e]/4,r=n[i];typeof r=="number"?this.#o[a]=r:typeof r=="boolean"?this.#i[a]=r?1:0:Array.isArray(r)&&this.#o.set(r,a)}this.#n.bindBuffer(this.#n.UNIFORM_BUFFER,this.#e),this.#n.bufferSubData(this.#n.UNIFORM_BUFFER,0,this.#t),this.#n.drawArrays(this.#n.TRIANGLE_STRIP,0,6)}}const En=s.createContext({name:"normal",themeActive:"no"}),ft=En.Provider,mt=({className:t,variablesRef:n,onViewportUpdate:e,onGlAvailable:i,onCanvasSizeUpdate:o,onRenderComplete:a,scale:r})=>{const{name:f,themeActive:g}=s.useContext(En),p=s.useMemo(()=>({className:Dn("flex items-center justify-center",t),vert:ut,onViewportUpdate:e,onRenderComplete:a,textureImage:K,textureName:"uTextureNoise",onGlAvailable:i,onCanvasSizeUpdate:o,scale:r}),[t,o,i,a,e,r]),[c]=De(we("yes",g)),u=s.useRef(void 0);switch(f){case"straw":return u.current=n.current?{...n.current,xmassMode:c}:void 0,d.jsx(An,{...p,frag:dt,GLUniformsSetter:Z,variablesRef:u});case"normal":return d.jsx(An,{...p,frag:ct,GLUniformsSetter:Y,variablesRef:n})}};function A(t){const n=t.replace("#",""),e=parseInt(n.substring(0,2),16)/255,i=parseInt(n.substring(2,4),16)/255,o=parseInt(n.substring(4,6),16)/255;return new Float32Array([e,i,o])}const q={BLUE:{bloopColorMain:A("#DCF7FF"),bloopColorLow:A("#0181FE"),bloopColorMid:A("#A4EFFF"),bloopColorHigh:A("#FFFDEF")},DARK_BLUE:{bloopColorMain:A("#DAF5FF"),bloopColorLow:A("#0066CC"),bloopColorMid:A("#2EC6F5"),bloopColorHigh:A("#72EAF5")},GREYSCALE:{bloopColorMain:A("#D7D7D7"),bloopColorLow:A("#303030"),bloopColorMid:A("#989898"),bloopColorHigh:A("#FFFFFF")},WHITE:{bloopColorMain:A("#FFFFFF"),bloopColorLow:A("#FFFFFF"),bloopColorMid:A("#FFFFFF"),bloopColorHigh:A("#FFFFFF")},BLACK:{bloopColorMain:A("#000000"),bloopColorLow:A("#000000"),bloopColorMid:A("#000000"),bloopColorHigh:A("#000000")}},vt=t=>{const{resolvedTheme:n}=Tn();return t?q.BLUE:n==="dark"?q.WHITE:q.BLACK},gt="items-center bg-transparent text-token-text-secondary",pt=({name:t})=>{const n=Rn();return d.jsx("button",{className:gt,"aria-label":n.formatMessage(bt.openInfoModal),children:d.jsx(F,{id:"wSx896",defaultMessage:"For ages 13+. {name} chats are <link>temporary</link>.",values:{name:t,link:e=>d.jsx("a",{href:"https://help.openai.com/en/articles/10139238",target:"_blank",rel:"noopener noreferrer",className:"underline",children:e})}})})},bt={openInfoModal:{id:"hintMessage.openInfoModal",defaultMessage:"Open info modal",description:"Open info modal about voice mode usage"},retry:{id:"hintMessage.retry",defaultMessage:"Retry",description:"Retry text next to lost connection message"}},Cn=[300,300],ht={bands:4,loPass:0,hiPass:400},xt=t=>{const n=e=>{let a=1-Math.max(-100,Math.min(-10,e))*-1/100;return a=Math.sqrt(a),a};return t.map(e=>e===-1/0?0:n(e))};function Pn(t,n){const[e,i]=s.useState([]),o=s.useRef(void 0);return s.useEffect(()=>{if(!t)return;if(!o.current){const u=new AudioContext,m=u.createMediaElementSource(t),l=u.createAnalyser();m.connect(l),l.connect(u.destination),o.current={audioContext:u,mediaElementAudioSourceNode:m,analyserNode:l}}const{analyserNode:a,audioContext:r}=o.current,f=a?.frequencyBinCount??0,g=new Float32Array(f),c=setInterval(()=>{if(!a)return;a.getFloatFrequencyData(g);let u=g.slice(n.loPass,n.hiPass);const m=xt(u),l=Math.ceil(m.length/n.bands),h=[];for(let b=0;b<n.bands;b++){const v=m.slice(b*l,(b+1)*l).reduce((w,x)=>w+x,0);h.push(v/l)}i(h)},n.updateInterval);return()=>{clearInterval(c),r&&r.close()}},[t,n.bands,n.hiPass,n.loPass,n.updateInterval]),e}const St=t=>{const n=Pn(t,{bands:X,updateInterval:P,loPass:0,hiPass:400,analyserOptions:{fftSize:Fn}});return n.length===0?Mn:n},yt=(t,n)=>{const e=St(t),i=_n(e,{sampleRate:zn,binCount:n.bins,bandCount:n.bands,gainMultipliers:n.gainMultipliers}),o=$({magnitudes:e,binCount:1,gainMultiplier:1});return{bandMagnitudes:i,cumulativeMagnitude:o}},At=t=>{const[n,e]=s.useState({audioData:[0,0,0,0],cumulativeAudioData:[0,0,0,0]}),i=s.useRef([0,0,0,0]),o=s.useRef(void 0),a=s.useRef(performance.now()),{bandMagnitudes:r,cumulativeMagnitude:f}=yt(t,{bands:3,bins:1,gainMultipliers:[10,1,1]});i.current=[...r,f].flat();const g=s.useCallback(()=>{const p=performance.now(),c=(p-a.current)/1e3;a.current=p;const u=i.current,{audioData:m,cumulativeAudioData:l}=n,h=Xe({deltaTimeS:c,audioDataRaw:u,prevAudioData:m,prevCumulativeAudioData:l});e(h)},[n]);return s.useEffect(()=>(o.current||(o.current=window.setInterval(g,P)),()=>{clearInterval(o.current),o.current=void 0}),[g]),n};function Nn({url:t,readyToPlay:n}){const e=s.useRef(void 0);return s.useEffect(()=>(e.current||(e.current=document.createElement("audio")),()=>{e.current?.remove()}),[]),s.useEffect(()=>{t&&e.current&&e.current.src!==t&&n&&(e.current.crossOrigin="anonymous",e.current.src=t,e.current.play())},[n,t]),e.current}function Ct({className:t,url:n}){const[e,i]=s.useState(!1),o=Nn({url:n,readyToPlay:e}),a=Pn(o,ht),r=s.useMemo(()=>[0,0,0,0],[]);return d.jsx(Ln,{className:t,isAdvanced:!1,avgMag:a,cumulativeAudioData:r,onRenderComplete:()=>i(!0)})}function wt({className:t,url:n}){const[e,i]=s.useState(!1),o=Nn({url:n,readyToPlay:e}),a=At(o),{audioData:r,cumulativeAudioData:f}=a;return d.jsx(Ln,{className:t,isAdvanced:!0,avgMag:r,cumulativeAudioData:f,onRenderComplete:()=>i(!0)})}const Ln=({className:t,avgMag:n,cumulativeAudioData:e,isAdvanced:i,onRenderComplete:o})=>{const{resolvedTheme:a}=Tn(),r=a==="dark",f=s.useMemo(()=>performance.now()/1e3,[]),g=s.useMemo(()=>performance.now()/1e3,[]),p=s.useRef(void 0),[c,u]=s.useState(Cn),{canvasSizeRef:m,handleCanvasSizeUpdate:l}=se(Cn),h=s.useCallback(C=>{u([C.width,C.height])},[]),[b,v]=s.useState(performance.now()/1e3);s.useEffect(()=>{const C=setInterval(()=>{v(performance.now()/1e3)},P);return()=>clearInterval(C)},[]);const w=vt(i),x=xe({viewport:c,canvasSize:m.current,shouldMeasurePerf:!0,source:"VoicePicker"}),S=Ae({shouldCalibrate:!0,viewport:c,initialScale:1});return p.current={time:b,micLevel:0,stateListen:0,listenTimestamp:0,stateThink:0,thinkTimestamp:0,stateSpeak:1,speakTimestamp:g,readyTimestamp:f,stateHalt:0,haltTimestamp:0,touchDownTimestamp:0,touchUpTimestamp:0,stateFailedToConnect:0,failedToConnectTimestamp:0,avgMag:n,cumulativeAudio:e,isNewBloop:!0,isAdvancedBloop:i,bloopColorMain:Array.from(w.bloopColorMain),bloopColorLow:Array.from(w.bloopColorLow),bloopColorMid:Array.from(w.bloopColorMid),bloopColorHigh:Array.from(w.bloopColorHigh),isDarkMode:r,screenScaleFactor:window.devicePixelRatio,viewport:c,silenceAmount:0,silenceTimestamp:0,fadeBloopWhileListening:!1},d.jsx(mt,{className:Dn("flex items-center justify-center",t),variablesRef:p,onViewportUpdate:h,onRenderComplete:o,textureImage:K,textureName:"uTextureNoise",onGlAvailable:x,onCanvasSizeUpdate:l,scale:S})},Dt={offscreenLeft:{x:"-24rem",opacity:0},left:{x:"-12rem",opacity:.5},center:{x:"0",opacity:1},right:{x:"12rem",opacity:.5},offscreenRight:{x:"24rem",opacity:0}};function Et({conversationId:t,onClose:n,cameFromNux:e=!1,initialVoiceName:i}){const{voiceName:o}=ie(),a=re(),[r,f]=s.useState(!1),g=fn.getGizmoId(t),[p,c]=s.useState(!1),[u,m]=s.useState(!1);s.useEffect(()=>{requestAnimationFrame(()=>c(!0))},[]);const[l,h]=s.useState(!1),[b,v]=s.useState(null);s.useEffect(()=>{if(a.length>0){const D=a.findIndex(dn=>dn.voice===(i||o));D>=0?v(D):v(2),h(!0)}},[a,o,i]);const w=b!=null?(b-2+a.length)%a.length:0,x=b!=null?(b-1+a.length)%a.length:1,S=b!=null?(b+1)%a.length:3,C=b!=null?(b+2)%a.length:4,y=a[b??0],T=a[w],J=a[x],Q=a[S],nn=a[C],M=y?.voice===G,en=le(),N=vn(B.hasSeenStrawSelection),_=s.useRef(!1);_.current=_.current||M;const tn=vn(ce()?B.hasStartedElectronVoiceModeStraw:B.hasStartedWebVoiceModeStraw),z=D=>{v(D)},{stopVoiceMode:on,startVoiceMode:an}=ge(e),L=ue(t),{setValue:sn}=te(Yn.VoiceName),In=pe(D=>D.voiceMode),I=e&&!g?"advanced":In,Bn=s.useCallback(async()=>{_.current&&N.markAsViewed(),m(!e),setTimeout(async()=>{f(!0);const D=b!=null?a[b]?.voice:a[0]?.voice;if(D===G&&tn.markAsViewed(),e||D!==o){e||W.voiceSelected.click({action:"changed",voice:D}),sn(D),await on(),de(`/?model=${L??gn}`);try{await an({conversation_id:void 0,model_slug:L??gn,eventSource:"voice_picker",voice_mode:I,voice:D,clientThreadId:Zn(),gizmo_id:fn.getGizmoId(t)})}catch(Vn){Jn.addError(`Failed to start voice mode after voice picker: ${Vn}`)}}else W.voiceSelected.click({action:"kept",voice:o});f(!1),n()},pn)},[e,t,o,N,L,n,b,sn,an,tn,on,I,a]),Un=()=>{_.current&&N.markAsViewed(),m(!0),setTimeout(n,pn)};fe({setSelectedVoiceIndex:v,prevVoiceIndex:x,nextVoiceIndex:S});const[rn,ln]=s.useState(!1),cn=D=>{D==="prev"?z(x):D==="next"&&z(S),ln(!0),setTimeout(()=>{ln(!1)},175)},un=s.useMemo(()=>({className:"h-max min-h-52 w-max min-w-52",url:y?.preview_url}),[y?.preview_url]),On=s.useMemo(()=>({name:en?"straw":"normal",themeActive:M?"yes":"no"}),[en,M]);return!l||b==null?d.jsx("div",{className:"fixed left-0 top-0 z-50 flex h-full w-full bg-token-main-surface-primary"}):d.jsxs("div",{className:`fixed left-0 top-0 z-50 flex h-full w-full flex-col items-center justify-center bg-white transition-opacity duration-300 dark:bg-gray-800 ${p&&!u?"opacity-100":"opacity-0"}`,children:[d.jsx("h1",{className:"mb-8 mt-36 text-3xl font-semibold",children:d.jsx(F,{id:"2whyE9",defaultMessage:"Choose a voice"})}),d.jsx("div",{className:"flex h-full w-full items-center justify-center",children:d.jsx(ft,{value:On,children:y?e&&!g||I==="advanced"?d.jsx(wt,{...un}):d.jsx(Ct,{...un}):null})}),d.jsx("div",{className:"mb-8 flex items-center justify-between text-center",children:d.jsxs("div",{className:"relative flex h-24 w-48",children:[d.jsx(k,{voice:T,variant:"offscreenLeft"},T?.name),d.jsx(k,{voice:J,variant:"left",onClick:()=>z(x)},J?.name),d.jsx(wn,{direction:"prev",onClick:()=>cn("prev"),isFading:rn}),d.jsx(k,{voice:y,variant:"center"},y?.name),d.jsx(wn,{direction:"next",onClick:()=>cn("next"),isFading:rn}),d.jsx(k,{voice:Q,variant:"right",onClick:()=>z(S)},Q?.name),d.jsx(k,{voice:nn,variant:"offscreenRight"},nn?.name),d.jsx("div",{className:"pointer-events-none absolute h-full w-full -translate-x-52 transform bg-gradient-to-r from-[var(--main-surface-background)] to-transparent"}),d.jsx("div",{className:"pointer-events-none absolute h-full w-full translate-x-52 transform bg-gradient-to-l from-[var(--main-surface-background)] to-transparent"}),d.jsx("div",{className:"pointer-events-none absolute h-full w-full -translate-x-96 transform bg-white dark:bg-gray-800"}),d.jsx("div",{className:"pointer-events-none absolute h-full w-full translate-x-96 transform bg-white dark:bg-gray-800"})]})}),d.jsxs("div",{className:"mb-36 flex flex-col space-y-3",children:[d.jsx(mn,{className:"w-52 whitespace-nowrap rounded-full px-20 py-3 font-semibold text-white",onClick:Bn,children:r?d.jsx(Qn,{}):y?.voice===o&&!e?d.jsx(F,{id:"MyKAgb",defaultMessage:"Done"}):d.jsx(F,{id:"7+3LaJ",defaultMessage:"Start new chat"})}),d.jsx(mn,{className:"w-52 rounded-full px-20 py-3 font-semibold text-black dark:text-white",color:"ghost",onClick:Un,children:d.jsx(F,{id:"dUn4Wd",defaultMessage:"Cancel"})})]}),M&&d.jsx("div",{className:"absolute bottom-12 left-1/2 -translate-x-1/2 transform text-xs",children:d.jsx(pt,{name:y.name})})]})}function k({voice:t,variant:n,onClick:e}){const i=t?.voice===G;return d.jsxs(be.button,{onClick:e,className:"absolute flex w-48 select-none flex-col items-center justify-center",variants:Dt,animate:n,initial:n,transition:{duration:.25,ease:"easeInOut"},children:[d.jsx("p",{className:`text-lg ${n==="center"?"font-semibold":""} ${i?"text-[#FF5656]":""}`,children:t?.name}),d.jsx("p",{className:"text-sm text-gray-600 dark:text-[var(--text-secondary)]",children:t?.description})]})}function wn({direction:t,onClick:n,isFading:e}){const i=t==="prev"?ne:ee,o=Rn(),a=t==="prev"?o.formatMessage({id:"ajuz05",defaultMessage:"Previous voice"}):o.formatMessage({id:"Dr8wrw",defaultMessage:"Next voice"});return d.jsx("button",{className:`duration-175 absolute ${t==="prev"?"-left-4":"-right-4"} top-2 z-50 transition-opacity ${e?"opacity-20":"opacity-100"}`,onClick:n,"aria-label":a,children:d.jsx(i,{className:"h-6 w-6 text-token-text-quaternary hover:text-token-text-secondary"})})}export{P as B,mt as T,Et as V,De as a,we as b,vt as c,xe as d,Ae as e,ft as f,K as n,Xe as s,zt as u};
//# sourceMappingURL=gtn5eh3dc9652n2d.js.map
