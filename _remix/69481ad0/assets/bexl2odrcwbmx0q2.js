import{l as e,m as U,V as S,r as p,a0 as Y,aM as Z,cq as Q,dd as k,es as d,ad as ee,bc as E,Z as r,W as te,aY as O}from"./ges7pegusuwm6s29.js";import{j as ae,k as se,e7 as re,d as oe,ag as J,a0 as w,I as ie,e8 as b}from"./ca47xldfgc4qco9w.js";import{Y as B}from"./mzkxlhrlmxhntkvn.js";import{A as ne}from"./m3v5x07t346om6zc.js";import{F as le,N as ce,aK as de,p as ue}from"./ddplc2knho8ipd47.js";import{F as me,a as L,b as N}from"./g6zs35tggznjt7mg.js";import{a as pe,b as he}from"./l33fe5nlugp79xgc.js";import"./k0upi5o9s0wxrxei.js";import"./nbmwj2w4tsu04xko.js";import"./ojzazouyqbkuftb8.js";import"./gy46wyrftjy0vuyn.js";import"./itg578mfa0m3728l.js";import"./o4lcgjydo2knimi5.js";import"./dbyqp2ocz19sykzs.js";import"./fsddy3bxlesj6ecw.js";import"./kutgoz5e2ft4h13s.js";import"./c6m6k2czozlk7157.js";import"./mbqafqf3tbml80kd.js";import"./cv7ysa9ok6nmnkmn.js";import"./hd9drzcqk9yulir7.js";import"./hrrdboulwb58im0p.js";import"./bydaueymoybbf1x8.js";import"./ipdnjzvc9qgu9d8m.js";import"./n6hdedz3y3c5s7lr.js";import"./d9edd7y5hgrectk0.js";import"./b46ufj41564w3gyi.js";import"./gzmf77dhe6gth9sd.js";import"./m0irv1lzqocj6bu2.js";import"./laecjf8sqlrz2ajc.js";import"./ddzr9naub0c5k7na.js";import"./cnhszz2eeox4dicf.js";import"./nyi7dujrkajwpd2b.js";import"./djmszy2iioxhbkk3.js";import"./9r9hhfxpviddcp3a.js";import"./k0f0opsm8n8rg6qn.js";import"./o55ydas7txiq2jhm.js";import"./iaes68sjohkx12ca.js";import"./5pio3zrqia6prnei.js";import"./bx10za4jc3z39hna.js";import"./dlu7q2z2l2anh7sv.js";import"./d2k5o8q0cm1cj92r.js";function xe({className:a,children:n,...o}){return e.jsx(ae,{className:a,...o,children:n})}const fe=({value:a,className:n,label:o,...l})=>e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx(se,{id:a,value:a,className:U("h-4 w-4 flex-shrink-0 gap-2 rounded-full border border-token-text-tertiary bg-transparent shadow-sm outline-none hover:bg-token-main-surface-tertiary",n),...l}),e.jsx("label",{htmlFor:a,className:"w-full cursor-pointer",children:o})]}),ge=({className:a,...n})=>e.jsx(re,{className:U("relative flex h-full w-full items-center justify-center after:block after:h-2 after:w-2 after:rounded-[50%] after:bg-token-text-primary after:content-['']",a),...n}),R={Root:xe,Item:fe,Indicator:ge};function ye({onSelectExample:a}){const n=S(),o=p.useRef(null);return e.jsxs("select",{onChange:l=>{if(l.target.value==="label")return;const t=parseInt(l.target.value);a(H[t].spec),o.current.value="label"},className:"h-8 rounded-lg border border-token-border-medium bg-transparent px-2 py-0 text-sm",ref:o,children:[e.jsx("option",{value:"label",children:n.formatMessage(I.examples)}),H.map((l,t)=>e.jsx("option",{value:t,children:n.formatMessage(l.displayName)},t))]})}const je={openapi:"3.1.0",info:{title:"Get weather data",description:"Retrieves current weather data for a location.",version:"v1.0.0"},servers:[{url:"https://weather.example.com"}],paths:{"/location":{get:{description:"Get temperature for a specific location",operationId:"GetCurrentWeather",parameters:[{name:"location",in:"query",description:"The city and state to retrieve the weather for",required:!0,schema:{type:"string"}}],deprecated:!1}}},components:{schemas:{}}},ve=`# Taken from https://github.com/OAI/OpenAPI-Specification/blob/main/examples/v3.0/petstore.yaml
...
//# sourceMappingURL=bexl2odrcwbmx0q2.js.map
