import{l as e,m as U,V as S,r as p,a0 as Z,aN as Y,cs as Q,di as k,eF as d,ad as ee,be as E,Z as r,W as te,aZ as O}from"./ox44qc35hzov2lc0.js";import{n as ae,o as se,ew as re,e as oe,ak as J,a5 as w,I as ie,ex as b}from"./n0vyqrw834x5h3pi.js";import{Y as B}from"./mzkxlhrlmxhntkvn.js";import{A as ne}from"./nvh8r3nt6elxmf02.js";import{F as le,N as ce,aN as de,p as ue}from"./nfkiq0ikssaghwl8.js";import{F as me,a as L,b as N}from"./pc3l2g6ge3yt19u7.js";import{a as pe,b as he}from"./ivq0axwfwcvl78d1.js";import"./giefuu4ksb7rfor7.js";import"./bmlmlp0l8cjb8lel.js";import"./pbne812r69qsc4hm.js";import"./obcz7x810wmnddjv.js";import"./i5z2dnpb19nvznlm.js";import"./jnwausdmdxsuogqo.js";import"./epnaxqxmpcssbyii.js";import"./fsddy3bxlesj6ecw.js";import"./drga0bg29ao6x3fw.js";import"./i4m08x1k5i9sbgwu.js";import"./g6tfuh5pr7m36s2a.js";import"./jd2nz1w9pfhbe3do.js";import"./fkntaymeywktqw3v.js";import"./4oetkpvngkf9ww63.js";import"./d166bqod1y3n4l4t.js";import"./l4y40ydq0s3f4q3m.js";import"./otqdynm5done9bex.js";import"./klu87pphdrk3rpg3.js";import"./ntnouc53auomh16c.js";import"./op40c97tc7bckwz3.js";import"./dss49363gsk9xy6r.js";import"./ahcb4da5pnyoqiup.js";import"./o4zann6q21l31p1s.js";import"./hqx9gjo6ek9wbj9w.js";import"./ebrp98io4knmfuhs.js";import"./ip6kndgfi8t9oalc.js";import"./gpo2zcrdomdelgdb.js";import"./ngszwrldrr16ix4o.js";import"./pby4oj0ay4dgwmkx.js";import"./nnpzxjfzpjmxb5oy.js";import"./g1ssq8h6kfq5cbt0.js";import"./k8j3nnxz78g9785h.js";import"./l4tlgvkxy4e8sdzc.js";import"./n8mrn4d5fadbh4an.js";function xe({className:a,children:n,...o}){return e.jsx(ae,{className:a,...o,children:n})}const fe=({value:a,className:n,label:o,...l})=>e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx(se,{id:a,value:a,className:U("h-4 w-4 flex-shrink-0 gap-2 rounded-full border border-token-text-tertiary bg-transparent shadow-sm outline-none hover:bg-token-main-surface-tertiary",n),...l}),e.jsx("label",{htmlFor:a,className:"w-full cursor-pointer",children:o})]}),ge=({className:a,...n})=>e.jsx(re,{className:U("relative flex h-full w-full items-center justify-center after:block after:h-2 after:w-2 after:rounded-[50%] after:bg-token-text-primary after:content-['']",a),...n}),R={Root:xe,Item:fe,Indicator:ge};function ye({onSelectExample:a}){const n=S(),o=p.useRef(null);return e.jsxs("select",{onChange:l=>{if(l.target.value==="label")return;const t=parseInt(l.target.value);a(H[t].spec),o.current.value="label"},className:"h-8 rounded-lg border border-token-border-medium bg-transparent px-2 py-0 text-sm",ref:o,children:[e.jsx("option",{value:"label",children:n.formatMessage(I.examples)}),H.map((l,t)=>e.jsx("option",{value:t,children:n.formatMessage(l.displayName)},t))]})}const je={openapi:"3.1.0",info:{title:"Get weather data",description:"Retrieves current weather data for a location.",version:"v1.0.0"},servers:[{url:"https://weather.example.com"}],paths:{"/location":{get:{description:"Get temperature for a specific location",operationId:"GetCurrentWeather",parameters:[{name:"location",in:"query",description:"The city and state to retrieve the weather for",required:!0,schema:{type:"string"}}],deprecated:!1}}},components:{schemas:{}}},ve=`# Taken from https://github.com/OAI/OpenAPI-Specification/blob/main/examples/v3.0/petstore.yaml
...
//# sourceMappingURL=ebk55sz5ub86qnar.js.map
