import{l as e,m as U,V as S,r as p,a0 as Z,aN as Y,cs as Q,di as k,eF as d,ad as ee,be as E,Z as r,W as te,aZ as O}from"./m22vykpz3ufxnjxd.js";import{n as ae,o as se,ew as re,e as oe,ak as J,a5 as w,I as ie,ex as b}from"./h96qd92qx1wl4bxm.js";import{Y as B}from"./mzkxlhrlmxhntkvn.js";import{A as ne}from"./b3e40wiv1ids34q8.js";import{F as le,N as ce,aN as de,p as ue}from"./hfrc69bv614p09qd.js";import{F as me,a as L,b as N}from"./gm46hzaqlc60dy89.js";import{a as pe,b as he}from"./d6ag2qprh4k9yz3v.js";import"./n13zt2dg444thhb4.js";import"./fzgvnbvf1g102okb.js";import"./fjsffie7vnsc9yaf.js";import"./b1vymk3b6yc5d4ka.js";import"./miejut141tryjzs3.js";import"./i5939eroqfuo9u68.js";import"./kx976eoy7979gedm.js";import"./fsddy3bxlesj6ecw.js";import"./el9udrhj2ej66c1f.js";import"./mdlymyewok0m0n32.js";import"./c1lxfkqsix2qq9xn.js";import"./mkf3fsn6mshphj49.js";import"./g7au1nc7vrn1o6m1.js";import"./jz8h3ndcgqzael8h.js";import"./crdiwge7dpbiv50m.js";import"./favm7ked21eekqbf.js";import"./jf3uv159nnq8mz4l.js";import"./kwaswicx5ahgniz3.js";import"./ks6fijcy00ptjpoc.js";import"./f0oc55sriof5sw8j.js";import"./mz47dnt57xn9xbfv.js";import"./1amqmdkp7ag4c04h.js";import"./l3wamhvc2cn5j4nw.js";import"./ntutsdxuf6pc9f26.js";import"./iut8qntwjhdqfd1c.js";import"./o7v1g8yg1camjq26.js";import"./kq2l3r1bxeoezqj0.js";import"./huhq40eda3wgtedy.js";import"./i63qzoueeqo4uawt.js";import"./m4v5fwlbnyg3h1ts.js";import"./b73jugcyhjtli0ky.js";import"./gcw8r2cm5143yiwj.js";import"./f97o0v5xi6lome36.js";import"./o985rmn813ns8dog.js";function xe({className:a,children:n,...o}){return e.jsx(ae,{className:a,...o,children:n})}const fe=({value:a,className:n,label:o,...l})=>e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx(se,{id:a,value:a,className:U("h-4 w-4 flex-shrink-0 gap-2 rounded-full border border-token-text-tertiary bg-transparent shadow-sm outline-none hover:bg-token-main-surface-tertiary",n),...l}),e.jsx("label",{htmlFor:a,className:"w-full cursor-pointer",children:o})]}),ge=({className:a,...n})=>e.jsx(re,{className:U("relative flex h-full w-full items-center justify-center after:block after:h-2 after:w-2 after:rounded-[50%] after:bg-token-text-primary after:content-['']",a),...n}),R={Root:xe,Item:fe,Indicator:ge};function ye({onSelectExample:a}){const n=S(),o=p.useRef(null);return e.jsxs("select",{onChange:l=>{if(l.target.value==="label")return;const t=parseInt(l.target.value);a(H[t].spec),o.current.value="label"},className:"h-8 rounded-lg border border-token-border-medium bg-transparent px-2 py-0 text-sm",ref:o,children:[e.jsx("option",{value:"label",children:n.formatMessage(I.examples)}),H.map((l,t)=>e.jsx("option",{value:t,children:n.formatMessage(l.displayName)},t))]})}const je={openapi:"3.1.0",info:{title:"Get weather data",description:"Retrieves current weather data for a location.",version:"v1.0.0"},servers:[{url:"https://weather.example.com"}],paths:{"/location":{get:{description:"Get temperature for a specific location",operationId:"GetCurrentWeather",parameters:[{name:"location",in:"query",description:"The city and state to retrieve the weather for",required:!0,schema:{type:"string"}}],deprecated:!1}}},components:{schemas:{}}},ve=`# Taken from https://github.com/OAI/OpenAPI-Specification/blob/main/examples/v3.0/petstore.yaml
...
//# sourceMappingURL=bftreezsc5x835p9.js.map
