import{l as e,m as U,V as S,r as p,a0 as Z,aN as Y,cs as Q,di as k,eF as d,ad as ee,be as E,Z as r,W as te,aZ as O}from"./mi4ha5f7fhlqv21j.js";import{j as ae,k as se,eu as re,d as oe,ah as J,a2 as w,I as ie,ev as b}from"./jt9rrlbcub4nr1o1.js";import{Y as B}from"./mzkxlhrlmxhntkvn.js";import{A as ne}from"./mpzj0f5rhd4wh2bb.js";import{F as le,N as ce,aL as de,p as ue}from"./fbiqn8pcnxli6gt8.js";import{F as me,a as L,b as N}from"./iwt5ddolpiy2rpb0.js";import{a as pe,b as he}from"./cgmi7t13tm1d74oo.js";import"./bsozo02ghpnmj03d.js";import"./crlpptjypvmi8lo4.js";import"./hynv8kai65ur4nb8.js";import"./l0jlhielviw9sjxi.js";import"./eksdfk2a9y27t5sp.js";import"./ckvkodvcgg4dr7vw.js";import"./d3f6n0a3z2jtitz4.js";import"./fsddy3bxlesj6ecw.js";import"./b89efj1nk6gsnboz.js";import"./mt2iir4k1fnqtunu.js";import"./b2vt7kjbna3lsfb4.js";import"./ipwws5wwj4uizt81.js";import"./haejwgw2o4ozczuk.js";import"./n0ja49gdh98nyi06.js";import"./jdvwdhwxq6qefu5p.js";import"./njrq50oqc7i7jhkw.js";import"./ic8xonudk832amag.js";import"./baxaru8fpwqoqpno.js";import"./o974672ovb02u7ur.js";import"./dk75az87rta2f7kt.js";import"./g8t1wjh28d32jja5.js";import"./n9gos3vzglsjkcv7.js";import"./hk8x3m1utmvru2or.js";import"./fzwkpc150wsohchj.js";import"./oyormi563z8zgnyz.js";import"./l3ti2og39k1w9uaw.js";import"./hi6m6lf5obzsc1ed.js";import"./e4vji9y52ptug12t.js";import"./dqks8ie3x46f32qy.js";import"./fkm85ya8ma3opl2d.js";import"./glapu0cd9iq91v4r.js";import"./b4pk0rhm9pganrbi.js";import"./kv3dpjrjf7vlpe74.js";import"./dha0cag88v5f5pid.js";function xe({className:a,children:n,...o}){return e.jsx(ae,{className:a,...o,children:n})}const fe=({value:a,className:n,label:o,...l})=>e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx(se,{id:a,value:a,className:U("h-4 w-4 flex-shrink-0 gap-2 rounded-full border border-token-text-tertiary bg-transparent shadow-sm outline-none hover:bg-token-main-surface-tertiary",n),...l}),e.jsx("label",{htmlFor:a,className:"w-full cursor-pointer",children:o})]}),ge=({className:a,...n})=>e.jsx(re,{className:U("relative flex h-full w-full items-center justify-center after:block after:h-2 after:w-2 after:rounded-[50%] after:bg-token-text-primary after:content-['']",a),...n}),R={Root:xe,Item:fe,Indicator:ge};function ye({onSelectExample:a}){const n=S(),o=p.useRef(null);return e.jsxs("select",{onChange:l=>{if(l.target.value==="label")return;const t=parseInt(l.target.value);a(H[t].spec),o.current.value="label"},className:"h-8 rounded-lg border border-token-border-medium bg-transparent px-2 py-0 text-sm",ref:o,children:[e.jsx("option",{value:"label",children:n.formatMessage(I.examples)}),H.map((l,t)=>e.jsx("option",{value:t,children:n.formatMessage(l.displayName)},t))]})}const je={openapi:"3.1.0",info:{title:"Get weather data",description:"Retrieves current weather data for a location.",version:"v1.0.0"},servers:[{url:"https://weather.example.com"}],paths:{"/location":{get:{description:"Get temperature for a specific location",operationId:"GetCurrentWeather",parameters:[{name:"location",in:"query",description:"The city and state to retrieve the weather for",required:!0,schema:{type:"string"}}],deprecated:!1}}},components:{schemas:{}}},ve=`# Taken from https://github.com/OAI/OpenAPI-Specification/blob/main/examples/v3.0/petstore.yaml
...
//# sourceMappingURL=kg6y80qdrdofyevx.js.map
