import{a6 as e,ar as U,aj as S,r as p,ak as Y,a3 as Z,c$ as Q,bW as k,e$ as d,J as ee,aK as E,aG as r,bI as te,a_ as O}from"./bve7stqsvuyp30oy.js";import{j as ae,k as se,g9 as re,d as oe,cj as B,eb as w,I as ne,ga as b}from"./ey0wg4za1oyqifqv.js";import{Y as H}from"./mzkxlhrlmxhntkvn.js";import{A as ie}from"./c3gotfd30lwnicmx.js";import{H as le,V as ce,aZ as de,r as ue}from"./jza0wh4acfmo8aml.js";import{F as me,a as L,b as N}from"./feg1zdap4g3j0zow.js";import{a as pe,b as he}from"./ek2z7jilic4bcg44.js";import"./fsddy3bxlesj6ecw.js";import"./ikea4zymh7bah5vz.js";import"./lk3ytoqve6n2hksk.js";import"./lcsvs3nxna2cdwpx.js";import"./deec37q0oqrigjkr.js";import"./25r7helde3zylny5.js";import"./ljvnn957d5onfwd2.js";import"./horqi5aemy4xy4nt.js";import"./j6nq6u5ihk30ar3w.js";import"./ocnf3ui8jti1f2ip.js";import"./jibp2s1dox9ncuc4.js";import"./m48yy4zuq608v31y.js";import"./cpolvx40ep4lcjwi.js";import"./jhw40ptxxcdznoc8.js";import"./gp6erypuqffyucu9.js";import"./daahzegdvawizu7d.js";import"./mp0614vfts6nkoji.js";import"./o8uyy9ytn5mdu56y.js";import"./fc8def5hazxahl9b.js";import"./dan2jejzay5j96ch.js";import"./djabdyap0pu9p9h6.js";function xe({className:a,children:i,...o}){return e.jsx(ae,{className:a,...o,children:i})}const fe=({value:a,className:i,label:o,...l})=>e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx(se,{id:a,value:a,className:U("h-4 w-4 flex-shrink-0 gap-2 rounded-full border border-token-text-tertiary bg-transparent shadow-sm outline-none hover:bg-token-main-surface-tertiary",i),...l}),e.jsx("label",{htmlFor:a,className:"w-full cursor-pointer",children:o})]}),ge=({className:a,...i})=>e.jsx(re,{className:U("relative flex h-full w-full items-center justify-center after:block after:h-2 after:w-2 after:rounded-[50%] after:bg-token-text-primary after:content-['']",a),...i}),R={Root:xe,Item:fe,Indicator:ge};function ye({onSelectExample:a}){const i=S(),o=p.useRef(null);return e.jsxs("select",{onChange:l=>{if(l.target.value==="label")return;const t=parseInt(l.target.value);a($[t].spec),o.current.value="label"},className:"h-8 rounded-lg border border-token-border-medium bg-transparent px-2 py-0 text-sm",ref:o,children:[e.jsx("option",{value:"label",children:i.formatMessage(I.examples)}),$.map((l,t)=>e.jsx("option",{value:t,children:i.formatMessage(l.displayName)},t))]})}const je={openapi:"3.1.0",info:{title:"Get weather data",description:"Retrieves current weather data for a location.",version:"v1.0.0"},servers:[{url:"https://weather.example.com"}],paths:{"/location":{get:{description:"Get temperature for a specific location",operationId:"GetCurrentWeather",parameters:[{name:"location",in:"query",description:"The city and state to retrieve the weather for",required:!0,schema:{type:"string"}}],deprecated:!1}}},components:{schemas:{}}},ve=`# Taken from https://github.com/OAI/OpenAPI-Specification/blob/main/examples/v3.0/petstore.yaml
