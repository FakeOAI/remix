import{l as e,m as U,V as S,r as p,a0 as Z,aN as Y,cs as Q,dj as k,eI as d,ad as ee,be as E,Z as r,W as te,aZ as O}from"./bkk1etpxp73xgxkk.js";import{n as ae,o as se,f5 as re,e as oe,ak as J,a5 as w,I as ie,f6 as b}from"./grdjxd4t00xxfgii.js";import{Y as B}from"./mzkxlhrlmxhntkvn.js";import{A as ne}from"./b80q596j6aj43zi4.js";import{F as le,N as ce,aO as de,p as ue}from"./ho6syd1yt6mfjuy1.js";import{F as me,a as L,b as N}from"./r7kw05sfejhx6328.js";import{a as pe,b as he}from"./latzj9ba081n7fm4.js";import"./go6iqv7kynl41ls2.js";import"./e2lvmkzz1krdd0vf.js";import"./on8dwna7kjymzk0v.js";import"./e9jy1ikfzj9e62os.js";import"./kef7p4k14zdf1y4l.js";import"./c7q13bl1gi8tl4t7.js";import"./noj1s37nphyqi49g.js";import"./fsddy3bxlesj6ecw.js";import"./dabzk7p57vaeradh.js";import"./dr411335yt1qs5ie.js";import"./d1ew373qviaqzay3.js";import"./i3sou16n7aet43d5.js";import"./nuovggdyf0grhuwv.js";import"./icc79zmdj63m59x2.js";import"./bhiswq7l6vnbbd9g.js";import"./ky3hwvkezt2frybr.js";import"./okhdof47k0vuhmqv.js";import"./gteko0382k8ggpbf.js";import"./brhx5v2rxlq0rxdf.js";import"./cvlbu2zjl8gk4d4y.js";import"./g6z1d4eznk0ak6cq.js";import"./nh4xoqtd53sztxo8.js";import"./jmirzj5na583pa7a.js";import"./b06mfhbavpg5kqfv.js";import"./mn3nu14cs11ir8z4.js";import"./ejywl3vwz3cnyccm.js";import"./o8dnah8yviaknm2n.js";import"./ickzndvtcdrritpi.js";import"./fw4xkoxv5qjc42j9.js";import"./hot1ma8xgzlmhu27.js";import"./ika2bxu0cscuhv38.js";import"./md7l2no35bs4azqe.js";import"./hcdhxk4ik5ew34s0.js";import"./o0rtkbpycqmde1l6.js";import"./bdn3rx7g7n1mngl6.js";function xe({className:a,children:n,...o}){return e.jsx(ae,{className:a,...o,children:n})}const fe=({value:a,className:n,label:o,...l})=>e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx(se,{id:a,value:a,className:U("h-4 w-4 flex-shrink-0 gap-2 rounded-full border border-token-text-tertiary bg-transparent shadow-sm outline-none hover:bg-token-main-surface-tertiary",n),...l}),e.jsx("label",{htmlFor:a,className:"w-full cursor-pointer",children:o})]}),ge=({className:a,...n})=>e.jsx(re,{className:U("relative flex h-full w-full items-center justify-center after:block after:h-2 after:w-2 after:rounded-[50%] after:bg-token-text-primary after:content-['']",a),...n}),R={Root:xe,Item:fe,Indicator:ge};function ye({onSelectExample:a}){const n=S(),o=p.useRef(null);return e.jsxs("select",{onChange:l=>{if(l.target.value==="label")return;const t=parseInt(l.target.value);a(H[t].spec),o.current.value="label"},className:"h-8 rounded-lg border border-token-border-medium bg-transparent px-2 py-0 text-sm",ref:o,children:[e.jsx("option",{value:"label",children:n.formatMessage(I.examples)}),H.map((l,t)=>e.jsx("option",{value:t,children:n.formatMessage(l.displayName)},t))]})}const je={openapi:"3.1.0",info:{title:"Get weather data",description:"Retrieves current weather data for a location.",version:"v1.0.0"},servers:[{url:"https://weather.example.com"}],paths:{"/location":{get:{description:"Get temperature for a specific location",operationId:"GetCurrentWeather",parameters:[{name:"location",in:"query",description:"The city and state to retrieve the weather for",required:!0,schema:{type:"string"}}],deprecated:!1}}},components:{schemas:{}}},ve=`# Taken from https://github.com/OAI/OpenAPI-Specification/blob/main/examples/v3.0/petstore.yaml
...
//# sourceMappingURL=do1rpk3s9eciu61p.js.map
