import{l as e,m as U,V as S,r as p,a0 as Y,aM as Z,cr as Q,dd as k,es as d,ad as ee,bd as E,Z as r,W as te,aY as O}from"./f1tbg9vupz7s4vaz.js";import{j as ae,k as se,e9 as re,d as oe,ag as J,a0 as w,I as ie,ea as b}from"./eyfm2skil9fzhvo1.js";import{Y as B}from"./mzkxlhrlmxhntkvn.js";import{A as ne}from"./lx6pbehlis8rcrmz.js";import{F as le,N as ce,aK as de,p as ue}from"./ku9ixf6u9z228exb.js";import{F as me,a as L,b as N}from"./d3l0jj29l0t7ue9i.js";import{a as pe,b as he}from"./em9hxpx2urdkieue.js";import"./jjp48s31c2bxsk72.js";import"./oixhn1b8fi6yhijp.js";import"./fitsuk0mifdju5f0.js";import"./gbwdai5w2ush8kio.js";import"./ix46tddc1xj4hezn.js";import"./hprljityfrryo2gz.js";import"./jdy1yw2t3lc2tl2b.js";import"./fsddy3bxlesj6ecw.js";import"./lvz3vh6ykh5o8ezo.js";import"./h00ups7ubwm6xfr6.js";import"./c77l8ej6lw2btxdd.js";import"./eg0vn9lfdm5eewe7.js";import"./fe4da7l7k2gvtlow.js";import"./ljaj5cms73a3s5g2.js";import"./fqhel6l5kixv21rc.js";import"./mt6h4jzk1jkcs287.js";import"./ioundd5um2qmksi3.js";import"./l45k6ig1jn8cj2c1.js";import"./jzmm2rrmfulao93u.js";import"./oirjgntd69ctrbs6.js";import"./iduegiibfbnnhhxj.js";import"./ab3r8vaqaocz8og0.js";import"./iwakq96x7vt4obk7.js";import"./abgj1vb4suh1frp8.js";import"./i7szpvpxevaselft.js";import"./ivpev86533cpi79d.js";import"./cb79tl9h1nhnbjw3.js";import"./b8d7o0pzbl5hx1cn.js";import"./ipl67ty0q5fdffnm.js";import"./lvqsfhnymxttluri.js";import"./eg44zdeoyh5lcz2a.js";import"./ncab5sw9ztwzfksi.js";import"./hb1w0me8vldwntrw.js";import"./bmogqv9axny003jx.js";function xe({className:a,children:n,...o}){return e.jsx(ae,{className:a,...o,children:n})}const fe=({value:a,className:n,label:o,...l})=>e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx(se,{id:a,value:a,className:U("h-4 w-4 flex-shrink-0 gap-2 rounded-full border border-token-text-tertiary bg-transparent shadow-sm outline-none hover:bg-token-main-surface-tertiary",n),...l}),e.jsx("label",{htmlFor:a,className:"w-full cursor-pointer",children:o})]}),ge=({className:a,...n})=>e.jsx(re,{className:U("relative flex h-full w-full items-center justify-center after:block after:h-2 after:w-2 after:rounded-[50%] after:bg-token-text-primary after:content-['']",a),...n}),R={Root:xe,Item:fe,Indicator:ge};function ye({onSelectExample:a}){const n=S(),o=p.useRef(null);return e.jsxs("select",{onChange:l=>{if(l.target.value==="label")return;const t=parseInt(l.target.value);a(H[t].spec),o.current.value="label"},className:"h-8 rounded-lg border border-token-border-medium bg-transparent px-2 py-0 text-sm",ref:o,children:[e.jsx("option",{value:"label",children:n.formatMessage(I.examples)}),H.map((l,t)=>e.jsx("option",{value:t,children:n.formatMessage(l.displayName)},t))]})}const je={openapi:"3.1.0",info:{title:"Get weather data",description:"Retrieves current weather data for a location.",version:"v1.0.0"},servers:[{url:"https://weather.example.com"}],paths:{"/location":{get:{description:"Get temperature for a specific location",operationId:"GetCurrentWeather",parameters:[{name:"location",in:"query",description:"The city and state to retrieve the weather for",required:!0,schema:{type:"string"}}],deprecated:!1}}},components:{schemas:{}}},ve=`# Taken from https://github.com/OAI/OpenAPI-Specification/blob/main/examples/v3.0/petstore.yaml
...
//# sourceMappingURL=c4xj9qoo6a7834gi.js.map
