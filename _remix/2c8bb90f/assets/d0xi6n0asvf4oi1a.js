import{l as e,m as U,V as S,r as p,a0 as Z,aN as Y,cs as Q,di as k,eF as d,ad as ee,be as E,Z as r,W as te,aZ as O}from"./msit3m24yq8wtq5q.js";import{n as ae,o as se,ew as re,e as oe,ak as J,a5 as w,I as ie,ex as b}from"./jcihqhf7cy65fsyu.js";import{Y as B}from"./mzkxlhrlmxhntkvn.js";import{A as ne}from"./f9wmunne99k0dijj.js";import{F as le,N as ce,aN as de,p as ue}from"./kagva72zvkrvo4t7.js";import{F as me,a as L,b as N}from"./3wrkkrrovml20l2w.js";import{a as pe,b as he}from"./j2mwlfh8sxwzhri5.js";import"./jpo22nc0d5ydvitd.js";import"./dzayn67rbbxy23lf.js";import"./eurytqek2z1thfdw.js";import"./nv7qkrmic7gf6ido.js";import"./br92jhppegkc7ldc.js";import"./mizt9nawbgd97gs9.js";import"./g3pyn5fq9xudhdtv.js";import"./fsddy3bxlesj6ecw.js";import"./df1oel2zwark1aif.js";import"./gr08khb5f7hhdveq.js";import"./knvghk01wf2lnjja.js";import"./e6wsimls8hx74el6.js";import"./nirnvufegovbukgm.js";import"./o5f7qvm67cns8was.js";import"./kyuwi818b8n087xj.js";import"./murlceynohuy6y9t.js";import"./ef1qodoxkrzote66.js";import"./chhoczkutabowff6.js";import"./kt48smjt24onjiip.js";import"./gbk5x81hm8ga0jmh.js";import"./ducugxusujhmr9f7.js";import"./k5hx438cozwlullo.js";import"./h6jev0d37826c80b.js";import"./ngkrpzafuq8npj5w.js";import"./jgtjtv9yw1sxerph.js";import"./m2dpvnzipv3utqa9.js";import"./dszmkfchbf0jajct.js";import"./j1cvggixqaoj9pzq.js";import"./nzliokwy6npqfkgs.js";import"./jtbsqniqet4byoer.js";import"./gm1v4z7og8qkhk10.js";import"./c87gncedy5ogzt8v.js";import"./ejlhmw0c8oph0bbn.js";import"./dicba5j6r0zkcyow.js";function xe({className:a,children:n,...o}){return e.jsx(ae,{className:a,...o,children:n})}const fe=({value:a,className:n,label:o,...l})=>e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx(se,{id:a,value:a,className:U("h-4 w-4 flex-shrink-0 gap-2 rounded-full border border-token-text-tertiary bg-transparent shadow-sm outline-none hover:bg-token-main-surface-tertiary",n),...l}),e.jsx("label",{htmlFor:a,className:"w-full cursor-pointer",children:o})]}),ge=({className:a,...n})=>e.jsx(re,{className:U("relative flex h-full w-full items-center justify-center after:block after:h-2 after:w-2 after:rounded-[50%] after:bg-token-text-primary after:content-['']",a),...n}),R={Root:xe,Item:fe,Indicator:ge};function ye({onSelectExample:a}){const n=S(),o=p.useRef(null);return e.jsxs("select",{onChange:l=>{if(l.target.value==="label")return;const t=parseInt(l.target.value);a(H[t].spec),o.current.value="label"},className:"h-8 rounded-lg border border-token-border-medium bg-transparent px-2 py-0 text-sm",ref:o,children:[e.jsx("option",{value:"label",children:n.formatMessage(I.examples)}),H.map((l,t)=>e.jsx("option",{value:t,children:n.formatMessage(l.displayName)},t))]})}const je={openapi:"3.1.0",info:{title:"Get weather data",description:"Retrieves current weather data for a location.",version:"v1.0.0"},servers:[{url:"https://weather.example.com"}],paths:{"/location":{get:{description:"Get temperature for a specific location",operationId:"GetCurrentWeather",parameters:[{name:"location",in:"query",description:"The city and state to retrieve the weather for",required:!0,schema:{type:"string"}}],deprecated:!1}}},components:{schemas:{}}},ve=`# Taken from https://github.com/OAI/OpenAPI-Specification/blob/main/examples/v3.0/petstore.yaml
...
//# sourceMappingURL=d0xi6n0asvf4oi1a.js.map
