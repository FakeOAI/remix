import{a6 as e,ar as L,aj as S,r as p,ak as Y,a3 as Q,c$ as Z,bW as k,e_ as d,J as ee,aK as E,aG as r,bI as te,a_ as O}from"./emaotesjjrbo0vnn.js";import{j as ae,k as se,fr as re,d as oe,c3 as J,dU as w,I as ne,fs as b}from"./pfgfa28h4zko09ji.js";import{Y as H}from"./mzkxlhrlmxhntkvn.js";import{A as ie}from"./j9o89tbhgk6ikf7x.js";import{H as le,V as ce,a_ as de,r as ue}from"./i2h9sd6w9obmp6kj.js";import{F as me,a as U,b as N}from"./jvwac9nipravog43.js";import{a as pe,b as he}from"./bjb1acah426h73un.js";import"./fsddy3bxlesj6ecw.js";import"./kdktmf60ad5o95ez.js";import"./f4d4hsc2yuigyhy9.js";import"./fokwkkbk6knx4amm.js";import"./uum3qt88kgyy5xax.js";import"./kn0ak9fkjsb1xfsy.js";import"./hd7b3v6d032g9uc2.js";import"./kye660kh5ct8polq.js";import"./cwrkr657k0yctpo3.js";import"./gp7374ju1voyvsik.js";import"./jo829q2ctc26m0v8.js";import"./d4972kkhqfka6fuz.js";import"./fjxlwcafgbqx6k83.js";import"./krrjy8wlh5tt1p9i.js";import"./h5woj1r6i6wwcaf0.js";import"./opzvq2rekkh5bmjo.js";import"./kad7loaf7djyppb1.js";import"./l55ilh4snakvqc47.js";import"./emdsbmtogavu6fd9.js";import"./m4qavq6u1tv4dyuu.js";import"./o3xzw4qwo16dikgu.js";function xe({className:a,children:i,...o}){return e.jsx(ae,{className:a,...o,children:i})}const fe=({value:a,className:i,label:o,...l})=>e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx(se,{id:a,value:a,className:L("h-4 w-4 flex-shrink-0 gap-2 rounded-full border border-token-text-tertiary bg-transparent shadow-sm outline-none hover:bg-token-main-surface-tertiary",i),...l}),e.jsx("label",{htmlFor:a,className:"w-full cursor-pointer",children:o})]}),ge=({className:a,...i})=>e.jsx(re,{className:L("relative flex h-full w-full items-center justify-center after:block after:h-2 after:w-2 after:rounded-[50%] after:bg-token-text-primary after:content-['']",a),...i}),R={Root:xe,Item:fe,Indicator:ge};function ye({onSelectExample:a}){const i=S(),o=p.useRef(null);return e.jsxs("select",{onChange:l=>{if(l.target.value==="label")return;const t=parseInt(l.target.value);a(B[t].spec),o.current.value="label"},className:"h-8 rounded-lg border border-token-border-medium bg-transparent px-2 py-0 text-sm",ref:o,children:[e.jsx("option",{value:"label",children:i.formatMessage(I.examples)}),B.map((l,t)=>e.jsx("option",{value:t,children:i.formatMessage(l.displayName)},t))]})}const je={openapi:"3.1.0",info:{title:"Get weather data",description:"Retrieves current weather data for a location.",version:"v1.0.0"},servers:[{url:"https://weather.example.com"}],paths:{"/location":{get:{description:"Get temperature for a specific location",operationId:"GetCurrentWeather",parameters:[{name:"location",in:"query",description:"The city and state to retrieve the weather for",required:!0,schema:{type:"string"}}],deprecated:!1}}},components:{schemas:{}}},ve=`# Taken from https://github.com/OAI/OpenAPI-Specification/blob/main/examples/v3.0/petstore.yaml
