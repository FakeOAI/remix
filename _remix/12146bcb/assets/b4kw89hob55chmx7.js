import{x as e,O as L,Y as S,r as p,a7 as Y,ah as Z,ck as Q,db as k,eE as d,B as ee,aw as E,a2 as r,br as te,aq as O}from"./h11ymloodq9g1jsm.js";import{o as ae,q as se,fk as re,h as oe,a1 as J,J as w,U as ie,fl as b}from"./d99imeng6jbz5fyz.js";import{Y as B}from"./mzkxlhrlmxhntkvn.js";import{A as ne}from"./oovfbumu240mg44a.js";import{F as le,O as ce,aZ as de,p as ue}from"./b4lc2pk5tx9fvyxr.js";import{F as me,a as U,b as N}from"./i4famerroaypbjp3.js";import{a as pe,b as he}from"./ixppyosrpr0qz9fp.js";import"./bjn84gz6ir9jwwg5.js";import"./eq74s9a1xv98w014.js";import"./jw64vuuhp544up6k.js";import"./dsaua33b1n5eatnj.js";import"./fzg4ztxf1dd6k2qj.js";import"./g2pntqylrpatuywn.js";import"./defoobo64skv3wz9.js";import"./o0yhon7qg91yktpl.js";import"./geaae92xvjdyqon0.js";import"./fsddy3bxlesj6ecw.js";import"./h0yesal4cg7q28d0.js";import"./f0dwr1dmswysxzbq.js";import"./la7sxhxz2eo8dk9z.js";import"./ojuvt29p72858xnp.js";import"./f62aedxhypzva2sq.js";import"./iua4ktursgg3kvfl.js";import"./izfvs4rurgoo3d97.js";import"./ea4quymaofxia95e.js";import"./fnfeqy3jvxa9ibes.js";import"./b6hh1v5wioa0vbs5.js";import"./l1y8k68hst3z986i.js";import"./bwdp3ugp1ll74h3f.js";import"./opy89b7ztw9itay4.js";import"./kwrfyfn5nclbwyy3.js";import"./nbao5u3al1pe401n.js";import"./b4n0k1szp5y82bgn.js";import"./ny0wwsk9p6l9g8t1.js";import"./bt9t46886d6r4cn7.js";import"./ioik0sgwbaicyza1.js";import"./i4pbtmme8aanx5d4.js";import"./n55i38s37jbldzag.js";import"./einjfbhe4extvag5.js";import"./cgd37mc74n5gfo99.js";import"./lnwf5tuhjzdd3csy.js";import"./noicuebnmmpp419p.js";function xe({className:a,children:n,...o}){return e.jsx(ae,{className:a,...o,children:n})}const fe=({value:a,className:n,label:o,...l})=>e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx(se,{id:a,value:a,className:L("h-4 w-4 flex-shrink-0 gap-2 rounded-full border border-token-text-tertiary bg-transparent shadow-sm outline-none hover:bg-token-main-surface-tertiary",n),...l}),e.jsx("label",{htmlFor:a,className:"w-full cursor-pointer",children:o})]}),ge=({className:a,...n})=>e.jsx(re,{className:L("relative flex h-full w-full items-center justify-center after:block after:h-2 after:w-2 after:rounded-[50%] after:bg-token-text-primary after:content-['']",a),...n}),R={Root:xe,Item:fe,Indicator:ge};function ye({onSelectExample:a}){const n=S(),o=p.useRef(null);return e.jsxs("select",{onChange:l=>{if(l.target.value==="label")return;const t=parseInt(l.target.value);a(H[t].spec),o.current.value="label"},className:"h-8 rounded-lg border border-token-border-medium bg-transparent px-2 py-0 text-sm",ref:o,children:[e.jsx("option",{value:"label",children:n.formatMessage(I.examples)}),H.map((l,t)=>e.jsx("option",{value:t,children:n.formatMessage(l.displayName)},t))]})}const je={openapi:"3.1.0",info:{title:"Get weather data",description:"Retrieves current weather data for a location.",version:"v1.0.0"},servers:[{url:"https://weather.example.com"}],paths:{"/location":{get:{description:"Get temperature for a specific location",operationId:"GetCurrentWeather",parameters:[{name:"location",in:"query",description:"The city and state to retrieve the weather for",required:!0,schema:{type:"string"}}],deprecated:!1}}},components:{schemas:{}}},ve=`# Taken from https://github.com/OAI/OpenAPI-Specification/blob/main/examples/v3.0/petstore.yaml
...
//# sourceMappingURL=b4kw89hob55chmx7.js.map
