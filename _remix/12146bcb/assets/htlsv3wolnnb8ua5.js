import{E as hn,cW as bn,fo as xn,fp as yn,cu as Sn,cY as An,g as Cn,r,c2 as I,x as l,av as on,O as wn,Y as Tn,bA as Dn,dJ as Fn,D as Rn,a2 as M,aw as Z,as as Mn}from"./h11ymloodq9g1jsm.js";import{F as kn,C as _n}from"./b4lc2pk5tx9fvyxr.js";import{u as En}from"./fckg6ul6qbqss1w4.js";import{F as Pn,w as J}from"./bjn84gz6ir9jwwg5.js";import{k as zn,l as In,m as Ln,a as Nn}from"./nu8kguox878ip4kc.js";import{hR as Un,h as Bn,hS as On,da as Vn,bA as jn}from"./d99imeng6jbz5fyz.js";import{b as Q}from"./eq74s9a1xv98w014.js";import{a as qn}from"./g2pntqylrpatuywn.js";import{m as Wn}from"./jw64vuuhp544up6k.js";const Gn="webp",Hn=512,Xn=512,$n="srgb",Kn=3,Yn="uchar",Zn=72,Jn=!1,Qn=8,ne=!1,ee=!1,te="https://cdn.oaistatic.com/assets/noise-watercolor-m3j88gni.webp",oe={format:Gn,width:Hn,height:Xn,space:$n,channels:Kn,depth:Yn,density:Zn,isProgressive:Jn,paletteBitDepth:Qn,hasProfile:ne,hasAlpha:ee,src:te};var ae=hn,se=bn;function ie(o){return se(o)&&ae(o)}var re=ie,le=xn,ce=Sn,ue=An,de=yn,fe=re,me=Math.max;function ge(o){if(!(o&&o.length))return[];var n=0;return o=le(o,function(t){if(fe(t))return n=me(t.length,n),!0}),de(n,function(t){return ce(o,ue(t))})}var pe=ge,ve=Un,he=pe,be=ve(he),xe=be;const E=Cn(xe),L=240,an=2048,ye=60,N=Math.floor(1e3/ye),sn=new Array(L).fill(0),Se=o=>{const n=zn(o,{bands:L,updateInterval:N,loPass:0,hiPass:400,analyserOptions:{fftSize:an}});return n.length===0?sn:n},U=o=>{const{magnitudes:n,binCount:t,gainMultiplier:s}=o;if(n.length===0)return new Array(t).fill(0);const a=Math.ceil(n.length/t),i=[];for(let c=0;c<n.length;c+=a){const p=Math.min(c+a,n.length),g=n.slice(c,p).sort((u,b)=>u-b),m=Math.floor(g.length/2);let v;g.length%2===0?v=(g[m-1]+g[m])/2:v=g[m],v=Math.abs(v),v*=s;const e=v/(v+1);i.push(e)}return i},rn=(o,n)=>{const t=n.sampleRate,s=o.length,a=n.bandCount,i=n.binCount,c=n.gainMultipliers;if(c.length!==a)throw new Error("gainMultipliers must have length equal to bandCount");const p=s*2,g=t/p,m=o.map((h,d)=>d*g),v=20,e=t/2,u=new Array(a+1).fill(0).map((h,d)=>v*Math.pow(e/v,d/a)),b=new Array(a).fill(null).map(()=>[]);for(let h=0;h<m.length;h+=1)for(let d=0;d<a;d+=1)if(m[h]>=u[d]&&m[h]<u[d+1]){b[d].push(o[h]);break}for(let h=0;h<a;h+=1){const d=b[h],f=c[h];b[h]=U({magnitudes:d,binCount:i,gainMultiplier:f})}return b},nn=60,ln=48e3,Ae=1,Ce=2,we=40,Te=2;function en({time:o,timeConstant:n}){return 1-Math.exp(-o/n)}function tn(o,n){const t=n[1]-n[0];return n[0]+o*t}const P=o=>{if(!Array.isArray(o)||o.length!==2||typeof o[0]!="number"||typeof o[1]!="number")throw new Error("zip failed - received a value that is not a [number, number] tuple")},De=o=>{const{prevAudioData:n,prevCumulativeAudioData:t,deltaTimeS:s,audioDataRaw:a}=o,i=a.map(u=>u*s*nn*Ae),c=en({time:s,timeConstant:Ce}),p=E(n,i).map(u=>(P(u),tn(c,u))),g=a.map(u=>u*s*nn*we),m=E(t,g).map(u=>(P(u),u[0]+u[1])),v=en({time:s,timeConstant:Te}),e=E(t,m).map(u=>(P(u),tn(v,u)));return{audioData:p,cumulativeAudioData:e}},Je=(o,n)=>{const t=Se(o),s=rn(t,{sampleRate:ln,binCount:n.bins,bandCount:n.bands,gainMultipliers:n.gainMultipliers}),a=U({magnitudes:t,binCount:1,gainMultiplier:1});return{bandMagnitudes:s,cumulativeMagnitude:a}};function Fe(o){const n=r.useRef(o);n.current=o;const[t,s]=r.useState(null),a=r.useCallback(i=>{s(i)},[]);return I(()=>{const i=new ResizeObserver(c=>{for(const p of c)n.current(p)});return t&&i.observe(t),()=>{i.disconnect()}},[t]),a}const T=In.createChild("GLCanvas");function Re({className:o,vert:n,frag:t,Behaviors:s,onViewportUpdate:a,onRenderComplete:i,onGlAvailable:c}){const p=r.useRef(null),g=r.useRef(null),[m,v]=r.useState(null),[e,u]=r.useState(),b=r.useRef(Bn(f=>{const{width:x,height:S}=f.contentRect,A=Math.floor(Math.min(x??0,S??0));v(A),a?.({width:A,height:A})},100)),h=Fe(b.current);if(I(()=>{const f=p.current,{width:x,height:S}=f??{};if(f&&m!=null&&x&&S){const A=f.getContext("webgl2",{premultipliedAlpha:!1});A?u(A):T.error("webgl2 context not supported")}},[m]),I(()=>{if(!e)return;const f=e.createProgram(),x=e.createShader(e.VERTEX_SHADER),S=e.createShader(e.FRAGMENT_SHADER);if(!f){T.debug("failed to create program");return}if(!x||!S){T.debug("failed to create shaders",x,S);return}let A="";if(e.shaderSource(x,n),e.compileShader(x),A+=`vertShader:
...
${A}`;g.current=f,T.debug("program created"),c?.(e,f);const F=e.fenceSync(e.SYNC_GPU_COMMANDS_COMPLETE,0);return F&&(e.waitSync(F,0,e.TIMEOUT_IGNORED),i?.()),()=>{T.debug("cleaning up"),g.current=null,e.detachShader(f,x),e.detachShader(f,S),e.deleteShader(x),e.deleteShader(S),e.deleteProgram(f)}},[e,t,n]),m!=null&&e&&p.current){const f=p.current,x=m*window.devicePixelRatio;f.width=x,f.height=x,e.viewport(0,0,x,x)}const d=g.current;return l.jsxs("div",{className:o,ref:h,children:[l.jsx("canvas",{ref:p,style:{width:m??void 0,height:m??void 0}},m),e&&d&&s&&l.jsx(s,{ctx:e,program:d})]})}function Me({ManagerClass:o,textureName:n,textureImage:t,variables:s,className:a,vert:i,frag:c,onViewportUpdate:p,onRenderComplete:g}){const m=r.useRef(void 0),v=r.useCallback((e,u)=>{if(m.current=new o(e,u),t&&n){const b=e.createTexture();e.bindTexture(e.TEXTURE_2D,b),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_WRAP_S,e.CLAMP_TO_EDGE),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_WRAP_T,e.CLAMP_TO_EDGE),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_MIN_FILTER,e.LINEAR),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_MAG_FILTER,e.LINEAR),e.texImage2D(e.TEXTURE_2D,0,e.RGBA,e.RGBA,e.UNSIGNED_BYTE,t);const h=e.getUniformLocation(u,n);e.activeTexture(e.TEXTURE0),e.bindTexture(e.TEXTURE_2D,b),e.uniform1i(h,0)}},[o,t,n]);return r.useEffect(()=>{m.current&&m.current.setVariablesAndRender(s)},[s]),l.jsx(Re,{className:a,vert:i,frag:c,onViewportUpdate:p,onRenderComplete:g,onGlAvailable:v,Behaviors:()=>null})}var ke=`#version 300 es
