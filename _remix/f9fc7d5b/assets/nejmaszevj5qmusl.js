import{l as e,m as U,V as S,r as p,a0 as Z,aN as Y,cs as Q,di as k,eG as d,ad as ee,be as E,Z as r,W as te,aZ as O}from"./ldmgmrz4k1q6ed5n.js";import{n as ae,o as se,ey as re,e as oe,ak as J,a5 as w,I as ie,ez as b}from"./il8crxbwclaclc75.js";import{Y as B}from"./mzkxlhrlmxhntkvn.js";import{A as ne}from"./nxmeshwxrvrwnzll.js";import{F as le,N as ce,aO as de,p as ue}from"./nfw6qo5mkhpyk7ym.js";import{F as me,a as L,b as N}from"./nbl78gsf8j733116.js";import{a as pe,b as he}from"./fk1kb8838ru5t6gj.js";import"./idw7sys1c2oa2i6c.js";import"./cbyvodb06ds84vgq.js";import"./g93qmzmxf1wr9awg.js";import"./deod98p42ilzt8gy.js";import"./biot7k05ldcinew6.js";import"./fom4zt3cusewtt6o.js";import"./h92f3ayftmoyqxjv.js";import"./fsddy3bxlesj6ecw.js";import"./d41reewaqg3k8vdv.js";import"./fqhu1mwkokhz5tr9.js";import"./ek18f4o0gb6hv959.js";import"./irdrgag61xlkj6se.js";import"./f844xbyapk4dqhm2.js";import"./gmezr8ivf0izcup2.js";import"./nkg4l2za6ncjgmyx.js";import"./k0iy3jypcij2b2oo.js";import"./i90uh1dlzveuocly.js";import"./ox60ql9dc1lwx4l4.js";import"./miqdu419nfq6dj62.js";import"./bjqbteqy8d3j40bu.js";import"./bm17e8lvrnkb4wl5.js";import"./ha3do6qsqiigj5jo.js";import"./70cqp64yxa9p6n2g.js";import"./nae970esod3k3i70.js";import"./e19oyuodg5cwjaak.js";import"./lugkzjbpl9wh0ixd.js";import"./jfq8gse5yfdt1bqf.js";import"./e0hgums8fp9vcocl.js";import"./ojey1fwnyvb4z2ox.js";import"./j2t40xcv7pbqw6af.js";import"./ji3ehjaw9ep344w4.js";import"./hswf2q5jiucoa03z.js";import"./mgxhmfwe8bgi8lws.js";import"./b2mdgcxjj0d7sxme.js";function xe({className:a,children:n,...o}){return e.jsx(ae,{className:a,...o,children:n})}const fe=({value:a,className:n,label:o,...l})=>e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx(se,{id:a,value:a,className:U("h-4 w-4 flex-shrink-0 gap-2 rounded-full border border-token-text-tertiary bg-transparent shadow-sm outline-none hover:bg-token-main-surface-tertiary",n),...l}),e.jsx("label",{htmlFor:a,className:"w-full cursor-pointer",children:o})]}),ge=({className:a,...n})=>e.jsx(re,{className:U("relative flex h-full w-full items-center justify-center after:block after:h-2 after:w-2 after:rounded-[50%] after:bg-token-text-primary after:content-['']",a),...n}),R={Root:xe,Item:fe,Indicator:ge};function ye({onSelectExample:a}){const n=S(),o=p.useRef(null);return e.jsxs("select",{onChange:l=>{if(l.target.value==="label")return;const t=parseInt(l.target.value);a(H[t].spec),o.current.value="label"},className:"h-8 rounded-lg border border-token-border-medium bg-transparent px-2 py-0 text-sm",ref:o,children:[e.jsx("option",{value:"label",children:n.formatMessage(I.examples)}),H.map((l,t)=>e.jsx("option",{value:t,children:n.formatMessage(l.displayName)},t))]})}const je={openapi:"3.1.0",info:{title:"Get weather data",description:"Retrieves current weather data for a location.",version:"v1.0.0"},servers:[{url:"https://weather.example.com"}],paths:{"/location":{get:{description:"Get temperature for a specific location",operationId:"GetCurrentWeather",parameters:[{name:"location",in:"query",description:"The city and state to retrieve the weather for",required:!0,schema:{type:"string"}}],deprecated:!1}}},components:{schemas:{}}},ve=`# Taken from https://github.com/OAI/OpenAPI-Specification/blob/main/examples/v3.0/petstore.yaml
...
//# sourceMappingURL=nejmaszevj5qmusl.js.map
