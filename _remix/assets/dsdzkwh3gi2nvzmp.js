import{di as s,j as e}from"./lqxieoavntgc1bwa.js";import{aZ as o}from"./lt376j8rwd79xpju.js";import{T as n}from"./dxuyxann4exlzgc2.js";import"./elw9by4pq97u474x.js";const d=()=>({index:Math.floor(Math.random()*t.length)});function m(){const{index:a}=s();return e.jsx("section",{className:"flex h-screen flex-col items-center justify-center",children:e.jsxs("div",{children:[e.jsxs("h3",{children:[e.jsx(o,{className:"mb-2 h-6 w-6 align-baseline"}),"404 Not Found"]}),e.jsx("p",{className:"mt-2 max-w-lg pb-8",children:e.jsx(n,{value:t[a].message,typing:!0,speed:150,chunk:!0})})]})})}const t=[{message:`Lost in the vast web,
...
//# sourceMappingURL=dsdzkwh3gi2nvzmp.js.map
