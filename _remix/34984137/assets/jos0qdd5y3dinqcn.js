import{l as e,m as U,V as S,r as p,a0 as Y,aM as Z,cq as Q,dd as k,es as d,ad as ee,bc as E,Z as r,W as te,aY as O}from"./kqqkpdulatnhj153.js";import{j as ae,k as se,e7 as re,d as oe,ag as J,a0 as w,I as ie,e8 as b}from"./n3rs6b5m6tqfdjyk.js";import{Y as B}from"./mzkxlhrlmxhntkvn.js";import{A as ne}from"./z2wbpzwqhhw44alo.js";import{F as le,N as ce,aK as de,p as ue}from"./nt24bg1lfwf9oh75.js";import{F as me,a as L,b as N}from"./j62qlh1y6zwtpo8f.js";import{a as pe,b as he}from"./jdp0uxq6jh1yie2i.js";import"./ljkmhw662c6t9mhx.js";import"./difcbbya6lgzvb2g.js";import"./esrcc953x6z04mp9.js";import"./ccpvrin2ogd4aji1.js";import"./lza6m5fvykifh7pz.js";import"./cjvbiw2g5fogbi08.js";import"./gg12z91ptfq2dx0l.js";import"./fsddy3bxlesj6ecw.js";import"./vrgqcxh8d9fcmv3j.js";import"./krbyppgfk0v8snp0.js";import"./n9ay93jbmqoqxpuq.js";import"./niicwal2u1ktt9ga.js";import"./fu8plhbz1k8c2c5r.js";import"./ldfj18v9arqp0hlo.js";import"./obxg6yogtza19s3r.js";import"./jjkswa78c00rb26q.js";import"./m30y9cks5frdds6a.js";import"./bcho5xlsyhfo0xx7.js";import"./jry911aolndx5jxk.js";import"./fjkyk9hftp5n5nq7.js";import"./c818qmxjxeib26ar.js";import"./n6tx0jdd43r4s9pl.js";import"./zsgatvow6n96fncl.js";import"./oe8l436iv77zqslu.js";import"./et7kjdu4e6pk2kyk.js";import"./mrs2nwjxl8hij5nc.js";import"./j7nrgauf0qsvjd0n.js";import"./jju24ktuta94ahij.js";import"./l7095upr2paz0cjp.js";import"./jfh9xe6djxacu3i5.js";import"./nvf62x04q7rioqy4.js";import"./jmj8xvc6etwfm8el.js";import"./dbirvjuqu6toc7gk.js";import"./bs1dh61qx9y3wbw7.js";function xe({className:a,children:n,...o}){return e.jsx(ae,{className:a,...o,children:n})}const fe=({value:a,className:n,label:o,...l})=>e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx(se,{id:a,value:a,className:U("h-4 w-4 flex-shrink-0 gap-2 rounded-full border border-token-text-tertiary bg-transparent shadow-sm outline-none hover:bg-token-main-surface-tertiary",n),...l}),e.jsx("label",{htmlFor:a,className:"w-full cursor-pointer",children:o})]}),ge=({className:a,...n})=>e.jsx(re,{className:U("relative flex h-full w-full items-center justify-center after:block after:h-2 after:w-2 after:rounded-[50%] after:bg-token-text-primary after:content-['']",a),...n}),R={Root:xe,Item:fe,Indicator:ge};function ye({onSelectExample:a}){const n=S(),o=p.useRef(null);return e.jsxs("select",{onChange:l=>{if(l.target.value==="label")return;const t=parseInt(l.target.value);a(H[t].spec),o.current.value="label"},className:"h-8 rounded-lg border border-token-border-medium bg-transparent px-2 py-0 text-sm",ref:o,children:[e.jsx("option",{value:"label",children:n.formatMessage(I.examples)}),H.map((l,t)=>e.jsx("option",{value:t,children:n.formatMessage(l.displayName)},t))]})}const je={openapi:"3.1.0",info:{title:"Get weather data",description:"Retrieves current weather data for a location.",version:"v1.0.0"},servers:[{url:"https://weather.example.com"}],paths:{"/location":{get:{description:"Get temperature for a specific location",operationId:"GetCurrentWeather",parameters:[{name:"location",in:"query",description:"The city and state to retrieve the weather for",required:!0,schema:{type:"string"}}],deprecated:!1}}},components:{schemas:{}}},ve=`# Taken from https://github.com/OAI/OpenAPI-Specification/blob/main/examples/v3.0/petstore.yaml
...
//# sourceMappingURL=jos0qdd5y3dinqcn.js.map
