import{l as e,m as U,V as S,r as p,a0 as Z,aN as Y,cs as Q,di as k,eF as d,ad as ee,be as E,Z as r,W as te,aZ as O}from"./knistvoayd9w5dlh.js";import{n as ae,o as se,ew as re,e as oe,ak as J,a5 as w,I as ie,ex as b}from"./bzpogxw1ym966dib.js";import{Y as B}from"./mzkxlhrlmxhntkvn.js";import{A as ne}from"./jdvsdu6316c9dtvg.js";import{F as le,N as ce,aN as de,p as ue}from"./egxlpxkjkn5vlr2a.js";import{F as me,a as L,b as N}from"./o2ugwzgjgrm6z5ip.js";import{a as pe,b as he}from"./d3pt230r5mvkqk0e.js";import"./c3cyng6qx8iiz8qa.js";import"./g3edk9aakj5fvio1.js";import"./f82fvalqosmyoquc.js";import"./i0c7avbvchmycpje.js";import"./29q49b6ohvllb80t.js";import"./hr63ipejtreaccw8.js";import"./l1uldd1k8t2kfbof.js";import"./fsddy3bxlesj6ecw.js";import"./k1g7ixcrm08fbb8r.js";import"./h9vj7n7cqctoc7pi.js";import"./ltygg1rmae4fu7m0.js";import"./jy0ytxf2nsk2z09n.js";import"./bo6ajkrtbac292qn.js";import"./oreqyxqpkhezhrvm.js";import"./e4d1gms1m9qt8gxd.js";import"./j54gpyg7scwggnwc.js";import"./gf1ybvsw9s8rxh1y.js";import"./e7mfms0j0nge19ns.js";import"./n8t4r72rt5wngx3w.js";import"./cl701stze59wfyly.js";import"./h4k9s58dkfbjfrht.js";import"./e95k6erq1i5ab2g1.js";import"./mo44rey4q9boshj7.js";import"./w8u6izfbi1diuc1i.js";import"./nphei4ty0d24vwoy.js";import"./l8fss1xcjpe6fkyh.js";import"./i59zj58kypm4uwpf.js";import"./ckkfcjx2sdlfhl2p.js";import"./kz1akz3adysr1hkk.js";import"./ddotepeck17pieaf.js";import"./cbflt7ed7lgr23wj.js";import"./hgkwov7jmsff50aq.js";import"./n1sqim0u030skfdd.js";import"./ihw6jvqw5ge4a1kd.js";function xe({className:a,children:n,...o}){return e.jsx(ae,{className:a,...o,children:n})}const fe=({value:a,className:n,label:o,...l})=>e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx(se,{id:a,value:a,className:U("h-4 w-4 flex-shrink-0 gap-2 rounded-full border border-token-text-tertiary bg-transparent shadow-sm outline-none hover:bg-token-main-surface-tertiary",n),...l}),e.jsx("label",{htmlFor:a,className:"w-full cursor-pointer",children:o})]}),ge=({className:a,...n})=>e.jsx(re,{className:U("relative flex h-full w-full items-center justify-center after:block after:h-2 after:w-2 after:rounded-[50%] after:bg-token-text-primary after:content-['']",a),...n}),R={Root:xe,Item:fe,Indicator:ge};function ye({onSelectExample:a}){const n=S(),o=p.useRef(null);return e.jsxs("select",{onChange:l=>{if(l.target.value==="label")return;const t=parseInt(l.target.value);a(H[t].spec),o.current.value="label"},className:"h-8 rounded-lg border border-token-border-medium bg-transparent px-2 py-0 text-sm",ref:o,children:[e.jsx("option",{value:"label",children:n.formatMessage(I.examples)}),H.map((l,t)=>e.jsx("option",{value:t,children:n.formatMessage(l.displayName)},t))]})}const je={openapi:"3.1.0",info:{title:"Get weather data",description:"Retrieves current weather data for a location.",version:"v1.0.0"},servers:[{url:"https://weather.example.com"}],paths:{"/location":{get:{description:"Get temperature for a specific location",operationId:"GetCurrentWeather",parameters:[{name:"location",in:"query",description:"The city and state to retrieve the weather for",required:!0,schema:{type:"string"}}],deprecated:!1}}},components:{schemas:{}}},ve=`# Taken from https://github.com/OAI/OpenAPI-Specification/blob/main/examples/v3.0/petstore.yaml
...
//# sourceMappingURL=cahup9pxi9uuvu6a.js.map
