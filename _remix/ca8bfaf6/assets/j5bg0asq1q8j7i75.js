const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/odmg6btihg0lh92a.js","assets/i50pu8hyebaw9kd6.js","assets/ler115iciu2bvc07.js","assets/root-kyx67gpb.css"])))=>i.map(i=>d[i]);
import{c as A,aE as d,Y as E,Z as N,r as s,d3 as W,aN as M,N as F,fc as O,j as e,aw as a,fd as R,az as w,aR as _,X as L}from"./i50pu8hyebaw9kd6.js";import{m as B}from"./mixmhi71ciem9jn6.js";import{ae as H,V as q}from"./ler115iciu2bvc07.js";const z={flags:{failwhaleBypassEnabled:!1,sharingEnabled:!1}},V=A()((i,n)=>({...z,updateFlagValue:(h,c)=>{const u=n().flags;i({flags:{...u,[h]:c}})}}));function Q(){const i=E(),n=N(),h=V(o=>o.flags.failwhaleBypassEnabled),[c,u]=s.useState(!1),[T,C]=s.useState(!1),m=W(),g=s.useRef(b[Math.floor(Math.random()*b.length)]),[r,k]=s.useState(!1),[x,p]=s.useState(!1),[f,P]=s.useState(!1),y=B();s.useEffect(()=>{document.title="ChatGPT",C(!0)},[]),s.useEffect(()=>{m(()=>{u(!0)},1e3)},[m]);const v=s.useCallback(async o=>{o.preventDefault();const G=o.target.email.value,I=(await M(async()=>{const{default:l}=await import("./odmg6btihg0lh92a.js").then(S=>S.i);return{default:l}},__vite__mapDeps([0,1,2,3]))).default,j=I(G);p(!0),F.getLoginLink(j).catch(l=>{n.danger(typeof l.message=="string"?l.message:O)}).finally(()=>{p(!1),k(!0)})},[n]);return T?e.jsx(D,{children:e.jsxs("div",{className:"relative flex h-full w-full overflow-hidden",children:[e.jsxs(J,{children:[e.jsx("div",{className:"text-3xl font-semibold",children:e.jsx(a,{...t.title})}),e.jsx("a",{href:"https://share.hsforms.com/13gyIEVN5SrScw-iVvCgIew4sk30",target:"_blank",rel:"noreferrer",className:"underline",children:e.jsx(a,{...t.getNotified})}),e.jsx("div",{className:"flex",children:e.jsx("div",{className:"font-bold",children:g.current.prompt})}),e.jsx("div",{className:"max-w-lg pb-8",children:e.jsx(R,{value:g.current.completion,typing:c,speed:150,chunk:!0})})]}),h&&e.jsx(Y,{$show:f,children:e.jsxs("div",{className:"relative m-6 flex w-full flex-col justify-center gap-4 text-gray-800 lg:max-w-sm lg:rounded-lg lg:border lg:p-6",children:[y&&e.jsx("h3",{children:e.jsx(a,{...t.chatGPTPlus})}),!y&&e.jsxs("button",{className:"text-center text-xl font-semibold lg:text-left",onClick:()=>P(o=>!o),children:[e.jsx(a,{...t.chatGPTPlus}),e.jsx(H,{className:w("icon-lg absolute right-0 top-0",!f&&"rotate-180")})]}),e.jsxs("div",{className:"m-auto flex w-full max-w-md flex-col gap-4 rounded-md border p-6 lg:border-0 lg:p-0",children:[!r&&e.jsx("p",{children:e.jsx(a,{...t.addEmail})}),r&&e.jsx("p",{children:e.jsx(a,{...t.allSet,values:{chatGPTPlus:e.jsx("a",{className:"underline",href:"https://openai.com/blog/chatgpt-plus/",children:"ChatGPT Plus"})}})}),e.jsxs("form",{onSubmit:v,children:[e.jsx("label",{htmlFor:"email",className:"hidden text-sm font-semibold text-gray-700",children:e.jsx(a,{...t.searchCandidates})}),e.jsxs("div",{className:"mt-1 flex rounded-md shadow-sm",children:[e.jsx("div",{className:"relative flex flex-grow items-stretch focus-within:z-10",children:e.jsx("input",{type:"email",name:"email",id:"email",className:w("form-input block w-full rounded-none rounded-l-md border-gray-300 focus:border-green-500 focus:ring-green-500 sm:text-sm",{"opacity-50":r}),required:!0,disabled:r,placeholder:i.formatMessage(t.emailPlaceholder)})}),e.jsx(_,{as:"button",color:"primary",className:"rounded-none rounded-r-md",type:"submit",disabled:r,loading:x,children:e.jsx("span",{className:"flex flex-row items-center space-x-1.5",children:r?e.jsxs(e.Fragment,{children:[e.jsx(q,{className:"icon-sm"}),e.jsx(a,{...t.sent})]}):e.jsx(a,{...t.sendLink})})})]})]}),e.jsx("p",{className:"text-sm",children:e.jsx(a,{...t.notSubscriber,values:{chatGPTPlus:e.jsx("a",{className:"underline",href:"https://openai.com/blog/chatgpt-plus/",children:"ChatGPT Plus"}),waitlist:o=>e.jsx("a",{href:"https://share.hsforms.com/1_-FpF2GTRJORIb83N3aK7Q4sk30",target:"_blank",rel:"noreferrer",className:"underline",children:o})}})})]})]})})]})}):null}const D=d.div`w-full h-full overflow-auto`,J=d.div`flex w-full max-w-lg mx-auto shrink-0 flex-col gap-6 overflow-auto px-6 pt-20 lg:w-3/5 lg:px-14 lg:pt-32 lg:max-w-none`,Y=d.div`absolute bottom-0 w-full lg:w-auto lg:relative flex flex-grow items-center justify-center bg-white rounded-t-xl lg:rounded-none transition-transform
...
//# sourceMappingURL=j5bg0asq1q8j7i75.js.map
