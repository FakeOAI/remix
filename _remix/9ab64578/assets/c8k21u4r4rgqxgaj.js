import{z as yn,dH as Sn,fC as An,fD as Cn,de as Tn,dJ as wn,g as Dn,r as c,cB as I,a6 as d,aO as rn,ar as Fn,c7 as Rn,bX as Mn,D as kn,aG as R,aK as J,b0 as _n,aj as En}from"./n6pd72le962cb7i2.js";import{H as Pn,E as zn}from"./b84o1u0lhllftt1g.js";import{u as In}from"./hy21uuzjkoi9r4jc.js";import{jP as Ln,d as Nn,jQ as Un,dd as Bn,a8 as Q,cy as On,bm as jn,dH as nn,jR as Vn}from"./jz3yie9s5yhl0osu.js";import{k as qn,l as Wn,m as Gn,a as Hn}from"./hdi6da5gb8sjik9d.js";import{m as Xn}from"./j8qj2mi7846az0e7.js";const en=300,Ze=async(t=1)=>{let n=0,e;return new Promise(i=>{const o=r=>(e||(e=r),r-e<t*1e3?(n+=1,requestAnimationFrame(o)):i(Math.floor(n/t)));requestAnimationFrame(o)})};var $n=yn,Kn=Sn;function Yn(t){return Kn(t)&&$n(t)}var Zn=Yn,Jn=An,Qn=Tn,ne=wn,ee=Cn,te=Zn,oe=Math.max;function ae(t){if(!(t&&t.length))return[];var n=0;return t=Jn(t,function(e){if(te(e))return n=oe(e.length,n),!0}),ee(n,function(e){return Qn(t,ne(e))})}var se=ae,ie=Ln,re=se,le=ie(re),ce=le;const E=Dn(ce),L=240,ln=2048,ue=60,N=Math.floor(1e3/ue),cn=new Array(L).fill(0),de=t=>{const n=qn(t,{bands:L,updateInterval:N,loPass:0,hiPass:400,analyserOptions:{fftSize:ln}});return n.length===0?cn:n},U=t=>{const{magnitudes:n,binCount:e,gainMultiplier:i}=t;if(n.length===0)return new Array(e).fill(0);const o=Math.ceil(n.length/e),r=[];for(let u=0;u<n.length;u+=o){const v=Math.min(u+o,n.length),p=n.slice(u,v).sort((a,h)=>a-h),m=Math.floor(p.length/2);let g;p.length%2===0?g=(p[m-1]+p[m])/2:g=p[m],g=Math.abs(g),g*=i;const s=g/(g+1);r.push(s)}return r},un=(t,n)=>{const e=n.sampleRate,i=t.length,o=n.bandCount,r=n.binCount,u=n.gainMultipliers;if(u.length!==o)throw new Error("gainMultipliers must have length equal to bandCount");const v=i*2,p=e/v,m=t.map((l,b)=>b*p),g=20,s=e/2,a=new Array(o+1).fill(0).map((l,b)=>g*Math.pow(s/g,b/o)),h=new Array(o).fill(null).map(()=>[]);for(let l=0;l<m.length;l+=1)for(let b=0;b<o;b+=1)if(m[l]>=a[b]&&m[l]<a[b+1]){h[b].push(t[l]);break}for(let l=0;l<o;l+=1){const b=h[l],f=u[l];h[l]=U({magnitudes:b,binCount:r,gainMultiplier:f})}return h},tn=60,dn=48e3,fe=1,me=2,ge=40,ve=2;function on({time:t,timeConstant:n}){return 1-Math.exp(-t/n)}function an(t,n){const e=n[1]-n[0];return n[0]+t*e}const P=t=>{if(!Array.isArray(t)||t.length!==2||typeof t[0]!="number"||typeof t[1]!="number")throw new Error("zip failed - received a value that is not a [number, number] tuple")},pe=t=>{const{prevAudioData:n,prevCumulativeAudioData:e,deltaTimeS:i,audioDataRaw:o}=t,r=o.map(a=>a*i*tn*fe),u=on({time:i,timeConstant:me}),v=E(n,r).map(a=>(P(a),an(u,a))),p=o.map(a=>a*i*tn*ge),m=E(e,p).map(a=>(P(a),a[0]+a[1])),g=on({time:i,timeConstant:ve}),s=E(e,m).map(a=>(P(a),an(g,a)));return{audioData:v,cumulativeAudioData:s}},Je=(t,n)=>{const e=de(t),i=un(e,{sampleRate:dn,binCount:n.bins,bandCount:n.bands,gainMultipliers:n.gainMultipliers}),o=U({magnitudes:e,binCount:1,gainMultiplier:1});return{bandMagnitudes:i,cumulativeMagnitude:o}};function be(t){const n=c.useRef(t);n.current=t;const[e,i]=c.useState(null),o=c.useCallback(r=>{i(r)},[]);return I(()=>{const r=new ResizeObserver(u=>{for(const v of u)n.current(v)});return e&&r.observe(e),()=>{r.disconnect()}},[e]),o}const w=Wn.createChild("GLCanvas");function he({className:t,vert:n,frag:e,Behaviors:i,onViewportUpdate:o,onRenderComplete:r,onGlAvailable:u}){const v=c.useRef(null),p=c.useRef(null),[m,g]=c.useState(null),[s,a]=c.useState(),h=c.useRef(Nn(f=>{const{width:x,height:S}=f.contentRect,A=Math.floor(Math.min(x??0,S??0));g(A),o?.({width:A,height:A})},100)),l=be(h.current);if(I(()=>{const f=v.current,{width:x,height:S}=f??{};if(f&&m!=null&&x&&S){const A=f.getContext("webgl2",{premultipliedAlpha:!1});A?a(A):w.error("webgl2 context not supported")}},[m]),I(()=>{if(!s)return;const f=s.createProgram(),x=s.createShader(s.VERTEX_SHADER),S=s.createShader(s.FRAGMENT_SHADER);if(!f){w.debug("failed to create program");return}if(!x||!S){w.debug("failed to create shaders",x,S);return}let A="";if(s.shaderSource(x,n),s.compileShader(x),A+=`vertShader:
...
${A}`;p.current=f,w.debug("program created"),u?.(s,f);const T=s.fenceSync(s.SYNC_GPU_COMMANDS_COMPLETE,0);return T&&(s.waitSync(T,0,s.TIMEOUT_IGNORED),r?.()),()=>{w.debug("cleaning up"),p.current=null,s.detachShader(f,x),s.detachShader(f,S),s.deleteShader(x),s.deleteShader(S),s.deleteProgram(f)}},[s,e,n]),m!=null&&s&&v.current){const f=v.current,x=m*window.devicePixelRatio;f.width=x,f.height=x,s.viewport(0,0,x,x)}const b=p.current;return d.jsxs("div",{className:t,ref:l,children:[d.jsx("canvas",{ref:v,style:{width:m??void 0,height:m??void 0}},m),s&&b&&i&&d.jsx(i,{ctx:s,program:b})]})}function xe({GLUniformsSetter:t,textureImage:n,textureName:e,variables:i,className:o,vert:r,frag:u,onViewportUpdate:v,onRenderComplete:p,onGlAvailable:m}){const g=c.useRef(void 0),s=c.useCallback(async(a,h)=>{if(g.current=new t(a,h),n&&e){const l=a.createTexture();a.bindTexture(a.TEXTURE_2D,l),a.texParameteri(a.TEXTURE_2D,a.TEXTURE_WRAP_S,a.CLAMP_TO_EDGE),a.texParameteri(a.TEXTURE_2D,a.TEXTURE_WRAP_T,a.CLAMP_TO_EDGE),a.texParameteri(a.TEXTURE_2D,a.TEXTURE_MIN_FILTER,a.LINEAR),a.texParameteri(a.TEXTURE_2D,a.TEXTURE_MAG_FILTER,a.LINEAR),a.texImage2D(a.TEXTURE_2D,0,a.RGBA,a.RGBA,a.UNSIGNED_BYTE,n);const b=a.getUniformLocation(h,e);a.activeTexture(a.TEXTURE0),a.bindTexture(a.TEXTURE_2D,l),a.uniform1i(b,0)}m?.(a,h)},[t,n,e,m]);return c.useEffect(()=>{g.current&&g.current.setVariablesAndRender(i)},[i]),d.jsx(he,{className:o,vert:r,frag:u,onViewportUpdate:v,onRenderComplete:p,onGlAvailable:s,Behaviors:()=>null})}const ye="webp",Se=512,Ae=512,Ce="srgb",Te=3,we="uchar",De=72,Fe=!1,Re=8,Me=!1,ke=!1,_e="https://cdn.oaistatic.com/assets/noise-watercolor-m3j88gni.webp",Ee={format:ye,width:Se,height:Ae,space:Ce,channels:Te,depth:we,density:De,isProgressive:Fe,paletteBitDepth:Re,hasProfile:Me,hasAlpha:ke,src:_e};let fn;const M=new window.Image;M.crossOrigin="anonymous";M.src=Ee.src;M.onload=()=>{fn=M};var Pe=`#version 300 es
