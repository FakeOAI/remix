import{r as s,cQ as jn,f4 as W,G as qn,cJ as Wn,hO as Hn,eZ as Gn,ho as Xn,hy as Kn,g as $n,e9 as H,m as f,aE as Dn,bV as Tn,L as Rn,bp as M,ah as fn,dx as Yn,dr as Zn,D as Jn,bD as mn,cy as Qn,bq as ne}from"./ltx0slge2qho99uv.js";import{lM as Fn,lN as ee,i as te,lO as oe,gM as ae,fp as se,i_ as G,lP as ie,i7 as vn,i8 as B,d1 as re,bA as le,aS as ce,j1 as gn,iZ as pn,lQ as ue,ia as de}from"./hqp2oo3dblqnwsc1.js";import{u as fe}from"./cg0w8agsoupb70gp.js";import{X as me,k as ve,l as ge,u as pe}from"./p0fl8lj99zltipp5.js";import{m as be}from"./fovwpcyu5xa7ulpu.js";const xe=2,he=({viewport:t,canvasSize:n,shouldMeasurePerf:e,source:i})=>{const o=s.useRef({}),a=s.useCallback(r=>{const m=r.getExtension("WEBGL_debug_renderer_info");m&&(o.current.vendor=r.getParameter(m.UNMASKED_VENDOR_WEBGL),o.current.renderer=r.getParameter(m.UNMASKED_RENDERER_WEBGL))},[]);return s.useEffect(()=>{const r={vendor:o.current.vendor??"(unavailable)",renderer:o.current.renderer??"(unavailable)",width:t[0],height:t[1],canvasWidth:n[0],canvasHeight:n[1],dpr:window.devicePixelRatio,source:i};!jn(r,o)&&e&&(o.current=r,Fn(xe).then(g=>{W.bloop.performance({...r,fps:g})}))},[n,e,t,i]),a},Se=.25,ye=3,bn=28,U=55,O=200,xn=1.1,Ae=({viewport:t,initialScale:n,shouldCalibrate:e})=>{const[i,o]=s.useState(n),a=s.useRef(void 0),r=s.useRef(void 0),m=s.useRef(void 0),g=s.useRef("down"),p=s.useCallback(()=>{const u=g.current==="up"?ye:Se;Fn(u).then(d=>{if(d<bn){g.current="down";const v=Math.max(d,1),l=Math.sqrt(v/bn);o(x=>x*l),r.current=window.setTimeout(p,O)}else if(m.current){const v=d>=U,l=d>=m.current*xn;if(v||l)g.current="up",o(x=>x*xn),r.current=window.setTimeout(p,O);else if(d<U){g.current="down";const x=Math.sqrt(d/U);o(b=>b*x)}}m.current=d})},[]);return s.useEffect(()=>{const[u,d]=t,[v,l]=a.current??[];return e&&(v!==u||l!==d)&&(a.current=t,clearTimeout(r.current),o(n),r.current=window.setTimeout(p,O)),()=>{clearTimeout(r.current)}},[e,p,n,t]),i},Ce=60,P=Math.floor(1e3/Ce),we=(t,n)=>{const[e,i]=s.useState(t===n?performance.now():0),o=s.useRef(n);s.useEffect(()=>{o.current!==n&&t===n&&i(performance.now()),o.current=n},[n,t]);const a=s.useCallback(()=>{i(0)},[]);return[t===n?1:0,e,a]},De=([t,n,e],i=500)=>{const[o,a]=s.useState(t),r=s.useRef(t),m=s.useRef(void 0),g=s.useCallback((p,u,d)=>{const v=l=>{const x=Math.min((l-p)/i,1),b=u+x*(d-u);a(b),x<1&&(m.current=requestAnimationFrame(v))};m.current=requestAnimationFrame(v)},[i]);return s.useEffect(()=>{if(r.current!==t){r.current=t,m.current&&cancelAnimationFrame(m.current);const p=o,u=t;g(performance.now(),p,u)}},[g,o,t]),[o,n/1e3,e]};var Te=qn,Re=Wn;function Fe(t){return Re(t)&&Te(t)}var Me=Fe,ke=Hn,_e=Gn,ze=Xn,Ee=Kn,Pe=Me,Ne=Math.max;function Le(t){if(!(t&&t.length))return[];var n=0;return t=ke(t,function(e){if(Pe(e))return n=Ne(e.length,n),!0}),Ee(n,function(e){return _e(t,ze(e))})}var Ie=Le,Be=ee,Ue=Ie,Oe=Be(Ue),Ve=Oe;const V=$n(Ve),X=240,Mn=2048,kn=new Array(X).fill(0),je=t=>{const n=me(t,{bands:X,updateInterval:P,loPass:0,hiPass:400,analyserOptions:{fftSize:Mn}});return n.length===0?kn:n},K=t=>{const{magnitudes:n,binCount:e,gainMultiplier:i}=t;if(n.length===0)return new Array(e).fill(0);const o=Math.ceil(n.length/e),a=[];for(let r=0;r<n.length;r+=o){const m=Math.min(r+o,n.length),g=n.slice(r,m).sort((v,l)=>v-l),p=Math.floor(g.length/2);let u;g.length%2===0?u=(g[p-1]+g[p])/2:u=g[p],u=Math.abs(u),u*=i;const d=u/(u+1);a.push(d)}return a},_n=(t,n)=>{const e=n.sampleRate,i=t.length,o=n.bandCount,a=n.binCount,r=n.gainMultipliers;if(r.length!==o)throw new Error("gainMultipliers must have length equal to bandCount");const m=i*2,g=e/m,p=t.map((x,b)=>b*g),u=20,d=e/2,v=new Array(o+1).fill(0).map((x,b)=>u*Math.pow(d/u,b/o)),l=new Array(o).fill(null).map(()=>[]);for(let x=0;x<p.length;x+=1)for(let b=0;b<o;b+=1)if(p[x]>=v[b]&&p[x]<v[b+1]){l[b].push(t[x]);break}for(let x=0;x<o;x+=1){const b=l[x],c=r[x];l[x]=K({magnitudes:b,binCount:a,gainMultiplier:c})}return l},hn=60,zn=48e3,qe=1,We=2,He=40,Ge=2;function Sn({time:t,timeConstant:n}){return 1-Math.exp(-t/n)}function yn(t,n){const e=n[1]-n[0];return n[0]+t*e}const j=t=>{if(!Array.isArray(t)||t.length!==2||typeof t[0]!="number"||typeof t[1]!="number")throw new Error("zip failed - received a value that is not a [number, number] tuple")},Xe=t=>{const{prevAudioData:n,prevCumulativeAudioData:e,deltaTimeS:i,audioDataRaw:o}=t,a=o.map(v=>v*i*hn*qe),r=Sn({time:i,timeConstant:We}),m=V(n,a).map(v=>(j(v),yn(r,v))),g=o.map(v=>v*i*hn*He),p=V(e,g).map(v=>(j(v),v[0]+v[1])),u=Sn({time:i,timeConstant:Ge}),d=V(e,p).map(v=>(j(v),yn(u,v)));return{audioData:m,cumulativeAudioData:d}},_t=(t,n)=>{const e=je(t),i=_n(e,{sampleRate:zn,binCount:n.bins,bandCount:n.bands,gainMultipliers:n.gainMultipliers}),o=K({magnitudes:e,binCount:1,gainMultiplier:1});return{bandMagnitudes:i,cumulativeMagnitude:o}},Ke="webp",$e=512,Ye=512,Ze="srgb",Je=3,Qe="uchar",nt=72,et=!1,tt=8,ot=!1,at=!1,st="https://cdn.oaistatic.com/assets/noise-watercolor-m3j88gni.webp",it={format:Ke,width:$e,height:Ye,space:Ze,channels:Je,depth:Qe,density:nt,isProgressive:et,paletteBitDepth:tt,hasProfile:ot,hasAlpha:at,src:st};let $;const E=new window.Image;E.crossOrigin="anonymous";E.src=it.src;E.onload=()=>{$=E};function rt(t){const n=s.useRef(t);n.current=t;const[e,i]=s.useState(null),o=s.useCallback(a=>{i(a)},[]);return H(()=>{const a=new ResizeObserver(r=>{for(const m of r)n.current(m)});return e&&a.observe(e),()=>{a.disconnect()}},[e]),o}const R=ve.createChild("GLCanvas");function lt({className:t,vert:n,frag:e,Behaviors:i,onViewportUpdate:o,onRenderComplete:a,onGlAvailable:r,onCanvasSizeUpdate:m,scale:g}){const p=s.useRef(null),u=s.useRef(null),[d,v]=s.useState(null),[l,x]=s.useState(),b=s.useRef(te(h=>{const{width:S,height:w}=h.contentRect,y=Math.floor(Math.min(S??0,w??0));v(y),o?.({width:y,height:y})},100)),c=rt(b.current);if(H(()=>{const h=p.current,{width:S,height:w}=h??{};if(h&&d!=null&&S&&w){const y=h.getContext("webgl2",{premultipliedAlpha:!0});y?x(y):R.error("webgl2 context not supported")}},[d]),H(()=>{if(!l)return;const h=l.createProgram(),S=l.createShader(l.VERTEX_SHADER),w=l.createShader(l.FRAGMENT_SHADER);if(!h){R.debug("failed to create program");return}if(!S||!w){R.debug("failed to create shaders",S,w);return}let y="";if(l.shaderSource(S,n),l.compileShader(S),y+=`vertShader:
...
void main() {
  ...
  fragColor = vec4(sdf.color.rgb * alpha, alpha);
}`;class Z{#o;#i;#n;#a=[];#s={};#e;#t;static#r="BlorbUniformsObject";constructor(n,e){this.#n=n;const i=n.getUniformBlockIndex(e,Z.#r),o=n.getActiveUniformBlockParameter(e,i,n.UNIFORM_BLOCK_DATA_SIZE);this.#e=n.createBuffer(),n.bindBuffer(n.UNIFORM_BUFFER,this.#e),n.bufferData(n.UNIFORM_BUFFER,o,n.DYNAMIC_DRAW);const a=0;n.bindBufferBase(n.UNIFORM_BUFFER,a,this.#e),n.uniformBlockBinding(e,i,a);const r=n.getActiveUniformBlockParameter(e,i,n.UNIFORM_BLOCK_ACTIVE_UNIFORM_INDICES);this.#a=[],this.#s={};for(let m=0;m<r.length;m++){const g=r[m],p=n.getActiveUniform(e,g);if(!p)throw new Error("No uniformInfo for index "+g);let u=p.name;u=u.replace(/\[0\]$/,"");const d=n.getActiveUniforms(e,[g],n.UNIFORM_OFFSET)[0];this.#a.push(u),this.#s[u]=d}this.#t=new ArrayBuffer(o),this.#o=new Float32Array(this.#t),this.#i=new Int32Array(this.#t)}setVariablesAndRender(n){for(const e of this.#a){const[,i]=e.split("."),a=this.#s[e]/4,r=n[i];typeof r=="number"?this.#o[a]=r:typeof r=="boolean"?this.#i[a]=r?1:0:Array.isArray(r)&&this.#o.set(r,a)}this.#n.bindBuffer(this.#n.UNIFORM_BUFFER,this.#e),this.#n.bufferSubData(this.#n.UNIFORM_BUFFER,0,this.#t),this.#n.drawArrays(this.#n.TRIANGLE_STRIP,0,6)}}const En=s.createContext({name:"normal",themeActive:"no"}),ft=En.Provider,mt=({className:t,variablesRef:n,onViewportUpdate:e,onGlAvailable:i,onCanvasSizeUpdate:o,onRenderComplete:a,scale:r})=>{const{name:m,themeActive:g}=s.useContext(En),p=s.useMemo(()=>({className:Dn("flex items-center justify-center",t),vert:ut,onViewportUpdate:e,onRenderComplete:a,textureImage:$,textureName:"uTextureNoise",onGlAvailable:i,onCanvasSizeUpdate:o,scale:r}),[t,o,i,a,e,r]),[u]=De(we("yes",g)),d=s.useRef(void 0);switch(m){case"straw":return d.current=n.current?{...n.current,xmassMode:u}:void 0,f.jsx(An,{...p,frag:dt,GLUniformsSetter:Z,variablesRef:d});case"normal":return f.jsx(An,{...p,frag:ct,GLUniformsSetter:Y,variablesRef:n})}};function A(t){const n=t.replace("#",""),e=parseInt(n.substring(0,2),16)/255,i=parseInt(n.substring(2,4),16)/255,o=parseInt(n.substring(4,6),16)/255;return new Float32Array([e,i,o])}const q={BLUE:{bloopColorMain:A("#DCF7FF"),bloopColorLow:A("#0181FE"),bloopColorMid:A("#A4EFFF"),bloopColorHigh:A("#FFFDEF")},DARK_BLUE:{bloopColorMain:A("#DAF5FF"),bloopColorLow:A("#0066CC"),bloopColorMid:A("#2EC6F5"),bloopColorHigh:A("#72EAF5")},GREYSCALE:{bloopColorMain:A("#D7D7D7"),bloopColorLow:A("#303030"),bloopColorMid:A("#989898"),bloopColorHigh:A("#FFFFFF")},WHITE:{bloopColorMain:A("#FFFFFF"),bloopColorLow:A("#FFFFFF"),bloopColorMid:A("#FFFFFF"),bloopColorHigh:A("#FFFFFF")},BLACK:{bloopColorMain:A("#000000"),bloopColorLow:A("#000000"),bloopColorMid:A("#000000"),bloopColorHigh:A("#000000")}},vt=t=>{const n=Tn();return t?q.BLUE:n?q.WHITE:q.BLACK},gt="items-center bg-transparent text-token-text-secondary",pt=({name:t})=>{const n=Rn();return f.jsx("button",{className:gt,"aria-label":n.formatMessage(bt.openInfoModal),children:f.jsx(M,{id:"DKRq3Z",defaultMessage:"For ages 13+. {name} chats are <link>temporary</link>.",values:{name:t,link:e=>f.jsx("a",{href:"https://help.openai.com/en/articles/10139238",target:"_blank",rel:"noopener noreferrer",className:"underline",children:e})}})})},bt={openInfoModal:{id:"hintMessage.openInfoModal",defaultMessage:"Open info modal",description:"Open info modal about voice mode usage"},retry:{id:"hintMessage.retry",defaultMessage:"Retry",description:"Retry text next to lost connection message"}},Cn=[300,300],xt={bands:4,loPass:0,hiPass:400},ht=t=>{const n=e=>{let a=1-Math.max(-100,Math.min(-10,e))*-1/100;return a=Math.sqrt(a),a};return t.map(e=>e===-1/0?0:n(e))};function Pn(t,n){const[e,i]=s.useState([]),o=s.useRef(void 0);return s.useEffect(()=>{if(!t)return;if(!o.current){const d=new AudioContext,v=d.createMediaElementSource(t),l=d.createAnalyser();v.connect(l),l.connect(d.destination),o.current={audioContext:d,mediaElementAudioSourceNode:v,analyserNode:l}}const{analyserNode:a,audioContext:r}=o.current,m=a?.frequencyBinCount??0,g=new Float32Array(m),u=setInterval(()=>{if(!a)return;a.getFloatFrequencyData(g);let d=g.slice(n.loPass,n.hiPass);const v=ht(d),l=Math.ceil(v.length/n.bands),x=[];for(let b=0;b<n.bands;b++){const c=v.slice(b*l,(b+1)*l).reduce((D,h)=>D+h,0);x.push(c/l)}i(x)},n.updateInterval);return()=>{clearInterval(u),r&&r.close()}},[t,n.bands,n.hiPass,n.loPass,n.updateInterval]),e}const St=t=>{const n=Pn(t,{bands:X,updateInterval:P,loPass:0,hiPass:400,analyserOptions:{fftSize:Mn}});return n.length===0?kn:n},yt=(t,n)=>{const e=St(t),i=_n(e,{sampleRate:zn,binCount:n.bins,bandCount:n.bands,gainMultipliers:n.gainMultipliers}),o=K({magnitudes:e,binCount:1,gainMultiplier:1});return{bandMagnitudes:i,cumulativeMagnitude:o}},At=t=>{const[n,e]=s.useState({audioData:[0,0,0,0],cumulativeAudioData:[0,0,0,0]}),i=s.useRef([0,0,0,0]),o=s.useRef(void 0),a=s.useRef(performance.now()),{bandMagnitudes:r,cumulativeMagnitude:m}=yt(t,{bands:3,bins:1,gainMultipliers:[10,1,1]});i.current=[...r,m].flat();const g=s.useCallback(()=>{const p=performance.now(),u=(p-a.current)/1e3;a.current=p;const d=i.current,{audioData:v,cumulativeAudioData:l}=n,x=Xe({deltaTimeS:u,audioDataRaw:d,prevAudioData:v,prevCumulativeAudioData:l});e(x)},[n]);return s.useEffect(()=>(o.current||(o.current=window.setInterval(g,P)),()=>{clearInterval(o.current),o.current=void 0}),[g]),n};function Nn({url:t,readyToPlay:n}){const e=s.useRef(void 0);return s.useEffect(()=>(e.current||(e.current=document.createElement("audio")),()=>{e.current?.remove()}),[]),s.useEffect(()=>{t&&e.current&&e.current.src!==t&&n&&(e.current.crossOrigin="anonymous",e.current.src=t,e.current.play())},[n,t]),e.current}function Ct({className:t,url:n}){const[e,i]=s.useState(!1),o=Nn({url:n,readyToPlay:e}),a=Pn(o,xt),r=s.useMemo(()=>[0,0,0,0],[]);return f.jsx(Ln,{className:t,isAdvanced:!1,avgMag:a,cumulativeAudioData:r,onRenderComplete:()=>i(!0)})}function wt({className:t,url:n}){const[e,i]=s.useState(!1),o=Nn({url:n,readyToPlay:e}),a=At(o),{audioData:r,cumulativeAudioData:m}=a;return f.jsx(Ln,{className:t,isAdvanced:!0,avgMag:r,cumulativeAudioData:m,onRenderComplete:()=>i(!0)})}const Ln=({className:t,avgMag:n,cumulativeAudioData:e,isAdvanced:i,onRenderComplete:o})=>{const a=Tn(),r=s.useMemo(()=>performance.now()/1e3,[]),m=s.useMemo(()=>performance.now()/1e3,[]),g=s.useRef(void 0),[p,u]=s.useState(Cn),{canvasSizeRef:d,handleCanvasSizeUpdate:v}=oe(Cn),l=s.useCallback(S=>{u([S.width,S.height])},[]),[x,b]=s.useState(performance.now()/1e3);s.useEffect(()=>{const S=setInterval(()=>{b(performance.now()/1e3)},P);return()=>clearInterval(S)},[]);const c=vt(i),D=he({viewport:p,canvasSize:d.current,shouldMeasurePerf:!0,source:"VoicePicker"}),h=Ae({shouldCalibrate:!0,viewport:p,initialScale:1});return g.current={time:x,micLevel:0,stateListen:0,listenTimestamp:0,stateThink:0,thinkTimestamp:0,stateSpeak:1,speakTimestamp:m,readyTimestamp:r,stateHalt:0,haltTimestamp:0,touchDownTimestamp:0,touchUpTimestamp:0,stateFailedToConnect:0,failedToConnectTimestamp:0,avgMag:n,cumulativeAudio:e,isNewBloop:!0,isAdvancedBloop:i,bloopColorMain:Array.from(c.bloopColorMain),bloopColorLow:Array.from(c.bloopColorLow),bloopColorMid:Array.from(c.bloopColorMid),bloopColorHigh:Array.from(c.bloopColorHigh),isDarkMode:a,screenScaleFactor:window.devicePixelRatio,viewport:p,silenceAmount:0,silenceTimestamp:0,fadeBloopWhileListening:!1},f.jsx(mt,{className:Dn("flex items-center justify-center",t),variablesRef:g,onViewportUpdate:l,onRenderComplete:o,textureImage:$,textureName:"uTextureNoise",onGlAvailable:D,onCanvasSizeUpdate:v,scale:h})},Dt={offscreenLeft:{x:"-24rem",opacity:0},left:{x:"-12rem",opacity:.5},center:{x:"0",opacity:1},right:{x:"12rem",opacity:.5},offscreenRight:{x:"24rem",opacity:0}};function zt({conversationId:t,onClose:n,cameFromNux:e=!1,initialVoiceName:i}){const{voiceName:o}=ae(),a=se(),[r,m]=s.useState(!1),g=fn.getGizmoId(t),[p,u]=s.useState(!1),[d,v]=s.useState(!1);s.useEffect(()=>{requestAnimationFrame(()=>u(!0))},[]);const[l,x]=s.useState(!1),[b,c]=s.useState(null);s.useEffect(()=>{if(a.length>0){const C=a.findIndex(dn=>dn.voice===(i||o));C>=0?c(C):c(2),x(!0)}},[a,o,i]);const D=b!=null?(b-2+a.length)%a.length:0,h=b!=null?(b-1+a.length)%a.length:1,S=b!=null?(b+1)%a.length:3,w=b!=null?(b+2)%a.length:4,y=a[b??0],T=a[D],J=a[h],Q=a[S],nn=a[w],k=y?.voice===G,en=ie(),N=vn(B.hasSeenStrawSelection),_=s.useRef(!1);_.current=_.current||k;const tn=vn(re()?B.hasStartedElectronVoiceModeStraw:B.hasStartedWebVoiceModeStraw),z=C=>{c(C)},{stopVoiceMode:on,startVoiceMode:an}=ge(e),L=le(t),{setValue:sn}=fe(Yn.VoiceName),In=pe(C=>C.voiceMode),I=e&&!g?"advanced":In,Bn=s.useCallback(async()=>{_.current&&N.markAsViewed(),v(!e),setTimeout(async()=>{m(!0);const C=b!=null?a[b]?.voice:a[0]?.voice;if(C===G&&tn.markAsViewed(),e||C!==o){e||W.voiceSelected.click({action:"changed",voice:C}),sn(C),await on(),ce(`/?model=${L??gn}`);try{await an({conversation_id:void 0,model_slug:L??gn,eventSource:"voice_picker",voice_mode:I,voice:C,clientThreadId:Zn(),gizmo_id:fn.getGizmoId(t)})}catch(Vn){Jn.addError(`Failed to start voice mode after voice picker: ${Vn}`)}}else W.voiceSelected.click({action:"kept",voice:o});m(!1),n()},pn)},[e,t,o,N,L,n,b,sn,an,tn,on,I,a]),Un=()=>{_.current&&N.markAsViewed(),v(!0),setTimeout(n,pn)};ue({setSelectedVoiceIndex:c,prevVoiceIndex:h,nextVoiceIndex:S});const[rn,ln]=s.useState(!1),cn=C=>{C==="prev"?z(h):C==="next"&&z(S),ln(!0),setTimeout(()=>{ln(!1)},175)},un=s.useMemo(()=>({className:"h-max min-h-52 w-max min-w-52",url:y?.preview_url}),[y?.preview_url]),On=s.useMemo(()=>({name:en?"straw":"normal",themeActive:k?"yes":"no"}),[en,k]);return!l||b==null?f.jsx("div",{className:"fixed left-0 top-0 z-50 flex h-full w-full bg-token-main-surface-primary"}):f.jsxs("div",{className:`fixed left-0 top-0 z-50 flex h-full w-full flex-col items-center justify-center bg-white transition-opacity duration-300 dark:bg-gray-800 ${p&&!d?"opacity-100":"opacity-0"}`,children:[f.jsx("h1",{className:"mb-8 mt-36 text-3xl font-semibold",children:f.jsx(M,{id:"2whyE9",defaultMessage:"Choose a voice"})}),f.jsx("div",{className:"flex h-full w-full items-center justify-center",children:f.jsx(ft,{value:On,children:y?e&&!g||I==="advanced"?f.jsx(wt,{...un}):f.jsx(Ct,{...un}):null})}),f.jsx("div",{className:"mb-8 flex items-center justify-between text-center",children:f.jsxs("div",{className:"relative flex h-24 w-48",children:[f.jsx(F,{voice:T,variant:"offscreenLeft"},T?.name),f.jsx(F,{voice:J,variant:"left",onClick:()=>z(h)},J?.name),f.jsx(wn,{direction:"prev",onClick:()=>cn("prev"),isFading:rn}),f.jsx(F,{voice:y,variant:"center"},y?.name),f.jsx(wn,{direction:"next",onClick:()=>cn("next"),isFading:rn}),f.jsx(F,{voice:Q,variant:"right",onClick:()=>z(S)},Q?.name),f.jsx(F,{voice:nn,variant:"offscreenRight"},nn?.name),f.jsx("div",{className:"pointer-events-none absolute h-full w-full -translate-x-52 transform bg-gradient-to-r from-[var(--main-surface-background)] to-transparent"}),f.jsx("div",{className:"pointer-events-none absolute h-full w-full translate-x-52 transform bg-gradient-to-l from-[var(--main-surface-background)] to-transparent"}),f.jsx("div",{className:"pointer-events-none absolute h-full w-full -translate-x-96 transform bg-white dark:bg-gray-800"}),f.jsx("div",{className:"pointer-events-none absolute h-full w-full translate-x-96 transform bg-white dark:bg-gray-800"})]})}),f.jsxs("div",{className:"mb-36 flex flex-col space-y-3",children:[f.jsx(mn,{className:"w-52 whitespace-nowrap rounded-full px-20 py-3 font-semibold text-white",onClick:Bn,children:r?f.jsx(Qn,{}):y?.voice===o&&!e?f.jsx(M,{id:"MyKAgb",defaultMessage:"Done"}):f.jsx(M,{id:"7+3LaJ",defaultMessage:"Start new chat"})}),f.jsx(mn,{className:"w-52 rounded-full px-20 py-3 font-semibold text-black dark:text-white",color:"ghost",onClick:Un,children:f.jsx(M,{id:"dUn4Wd",defaultMessage:"Cancel"})})]}),k&&f.jsx("div",{className:"absolute bottom-12 left-1/2 -translate-x-1/2 transform text-xs",children:f.jsx(pt,{name:y.name})})]})}function F({voice:t,variant:n,onClick:e}){const i=t?.voice===G;return f.jsxs(be.button,{onClick:e,className:"absolute flex w-48 select-none flex-col items-center justify-center",variants:Dt,animate:n,initial:n,transition:{duration:.25,ease:"easeInOut"},children:[f.jsx("p",{className:`text-lg ${n==="center"?"font-semibold":""} ${i?"text-[#FF5656]":""}`,children:t?.name}),f.jsx("p",{className:"text-sm text-gray-600 dark:text-[var(--text-secondary)]",children:t?.description})]})}function wn({direction:t,onClick:n,isFading:e}){const i=t==="prev"?de:ne,o=Rn(),a=t==="prev"?o.formatMessage({id:"ajuz05",defaultMessage:"Previous voice"}):o.formatMessage({id:"Dr8wrw",defaultMessage:"Next voice"});return f.jsx("button",{className:`duration-175 absolute ${t==="prev"?"-left-4":"-right-4"} top-2 z-50 transition-opacity ${e?"opacity-20":"opacity-100"}`,onClick:n,"aria-label":a,children:f.jsx(i,{className:"h-6 w-6 text-token-text-quaternary hover:text-token-text-secondary"})})}export{P as B,mt as T,zt as V,De as a,we as b,vt as c,he as d,Ae as e,ft as f,$ as n,Xe as s,_t as u};
//# sourceMappingURL=nngo16wxr2hz3moj.js.map
