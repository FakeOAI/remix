import{bg as s,j as e}from"./hc9xxm00a3r3byem.js";import{O as o}from"./facz9srd4e5z6fv5.js";import{T as n}from"./oswf6zj9n6u9ofyv.js";import"./fga5qe14lr2llx8v.js";import"./ozzpumen10p6g0yq.js";const m=()=>({index:Math.floor(Math.random()*t.length)});function c(){const{index:a}=s();return e.jsx("section",{className:"flex h-screen flex-col items-center justify-center",children:e.jsxs("div",{children:[e.jsxs("h3",{children:[e.jsx(o,{className:"mb-2 h-6 w-6 align-baseline"}),"404 Not Found"]}),e.jsx("p",{className:"mt-2 max-w-lg pb-8",children:e.jsx(n,{value:t[a].message,typing:!0,speed:150,chunk:!0})})]})})}const t=[{message:`Lost in the vast web,
...
An empty mirage.`},{message:`Welcome, traveler. You’ve reached a page that doesn't exist, a place where content used to be—or maybe never was. Let’s take this moment to pause and reflect.
...
Thank you for taking this moment of calm. Your journey continues.`}];export{m as clientLoader,c as default};
//# sourceMappingURL=mcb6uav7r48d2zrx.js.map
